        ...
        !(function (i, o) {
          if (i) {
            ...
            (s.noConflict = function () {
                ...
                function c(t, i, n, r, a) {
                  if (d)
                    ...
                    (c.func = s.computeStackTrace.guessFunctionName(
                      ...
                      A(
                        { name: o, message: p, mode: "onerror", stack: [c] },
                        !0,
                        null
                      );
                  }
                  ...
                  for (
                    ...
                    if (u !== f && u !== s.report) {
                      if (
                        ...
                        u.name
                          ? (n.func = u.name)
                          : (i = o.exec(u.toString())) && (n.func = i[1]),
                        void 0 === n.func)
                      )
                        try {
              ...
              (r = []),
              void 0 ===
                (a = "function" == typeof (n = s) ? n.apply(t, r) : n) ||
                (e.exports = a);
          }
          function p(e, t) {
    ...
    (() => {
      ...
      var A = {
        ...
        c = {
          ...
          NL: {
            video: { ix: 0.39, onetag: 0.81, openx: 0.71, richaudience: 0.72 },
          },
          ...
          return (
            ...
            (e.trackSavegames = function () {
              window.cookieStore &&
                ...
                (Math.random() > 0.01 ||
                  (k ||
                    ((k = Math.random().toString(36).substr(2, 9)), g(y, k)),
                  e.collectAndLog(),
        ...
        W = function (e) {
          ...
          return {
            bids: [
              {
                bidder: "appnexus",
                params: { placementId: 13184250, supplyType: "web" },
              },
              {
                bidder: "openx",
              ...
              {
                bidder: "richaudience",
                params: { pid: T(H), supplyType: "site" },
              },
              ...
              {
                bidder: "pubmatic",
                params: { publisherId: "156838", adSlot: "3607869@640x360" },
              },
              { bidder: "districtm", params: { placementId: 12906789 } },
            ],
            mediaTypes: {
              video: U({ context: "instream", playerSize: [640, 480] }, i),
            },
          };
        },
        V = W(!0),
        ...
        J = [
          ...
          { code: X, mediaTypes: V.mediaTypes, bids: N([], V.bids, !0) },
          {
            ...
            bids: [
              ...
              {
                bidder: "openx",
                params: { unit: "539859872", delDomain: "poki-d.openx.net" },
              },
              { bidder: "ix", params: { siteId: "268177", size: [728, 90] } },
              {
                bidder: "pubmatic",
                params: { publisherId: "156838", adSlot: "1374895@728x90" },
              },
              { bidder: "emx_digital", params: { tagid: "80117" } },
              {
                bidder: "conversant",
                params: { site_id: "117477", secure: 1, position: 1 },
              },
              {
                bidder: "rubicon",
                params: {
          ...
          },
          {
            ...
            bids: [
              ...
              {
                bidder: "openx",
                params: { unit: "539859873", delDomain: "poki-d.openx.net" },
              },
              { bidder: "ix", params: { siteId: "268178", size: [300, 250] } },
              {
                bidder: "pubmatic",
                params: { publisherId: "156838", adSlot: "1374896@300x250" },
              },
          ...
          },
          {
            ...
            bids: [
              ...
              {
                bidder: "openx",
                params: { unit: "543540497", delDomain: "poki-d.openx.net" },
              },
              { bidder: "ix", params: { siteId: "597527", size: [970, 250] } },
              {
                bidder: "pubmatic",
                params: { publisherId: "156838", adSlot: "3344351@970x250" },
              },
          ...
          },
          {
            ...
            bids: [
              ...
              {
                bidder: "openx",
                params: { unit: "539859871", delDomain: "poki-d.openx.net" },
              },
              { bidder: "ix", params: { siteId: "268175", size: [160, 600] } },
              {
                bidder: "pubmatic",
                params: { publisherId: "156838", adSlot: "1374893@160x600" },
              },
          ...
          },
          {
            ...
            bids: [
              ...
              {
                bidder: "openx",
                params: { unit: "543540495", delDomain: "poki-d.openx.net" },
              },
              { bidder: "ix", params: { siteId: "597529", size: [320, 50] } },
              {
                bidder: "pubmatic",
                params: { publisherId: "156838", adSlot: "3344350@320x50" },
              },
              {
                bidder: "conversant",
                params: { site_id: "117477", secure: 1, position: 1 },
          ...
          (function (e, t) {
            var i,
              ...
              r =
                null ===
                  (n =
                    null === (i = e[(t = t.toUpperCase())]) || void 0 === i
                      ? void 0
                      : i.video) || void 0 === n
                  ? void 0
                  : n.amazon;
              ...
              if (!(--m > 0))
                try {
                  ...
                  if (s) {
                    ...
                    if (!f || !f.videoCacheKey)
                      return void o.dispatchEvent(n.ads.completed);
                    switch (f.bidder) {
                      case "onetag":
                        l =
                          "https://onetag-sys.com/invocation/?key=" +
                          f.videoCacheKey;
                        break;
                      case "rubicon":
                        l =
                  ...
                  if (
                    (o.setDataAnnotations({ vhbOnlyMode: v, adTagUrl: l }),
                    g.length > 0)
                  ) {
                    f = g[0];
                    o.setDataAnnotations({
      ...
      const Re = (function () {
        ...
        return (
          ...
          (e.prototype.resumeAd = function () {
            o.dispatchEvent(n.ads.video.resumed),
        ...
        return (
          ...
          (e.prototype.bidsBackHandler = function (e) {
            ...
            t &&
              ...
              (t.adserverTargeting =
                window.pbjs.getAdserverTargetingForAdUnitCode([t.adUnitPath])),
            ...
            (t.prototype.bidsBackHandler = function (e) {
              ...
              if (r) {
                ...
                if (o) {
                  o.appendChild(a);
                  var s =
                    null === (t = null == a ? void 0 : a.contentWindow) ||
                    void 0 === t
                      ? void 0
                      : t.document;
                  if (!s)
                      ...
                      function (e) {
                        e.forEach(function (e) {
                          e.isIntersecting
                            ...
                            : r.intersectingTimer &&
                              (clearTimeout(r.intersectingTimer),
                              (r.intersectingTimer = void 0));
                        });
                      },
                      { threshold: 0.5 }
                    )),
      ...
      var $e = function () {
        ...
        it = (function () {
          function e() {
            ...
            var t = _("pokiDebug");
            "" !== t &&
              (this.setDebug("true" === t), (this.debugIsOverwritten = !0)),
          ...
          return (
            ...
            (e.prototype.destroyAd = function (e) {
              if (!this.sdkBooted)
                return o.dispatchEvent(), void this.sdkNotBootedButCalled();
              this.sdkImaError
                ? o.dispatchEvent()
            ...
            (e.prototype.enableSettings = function (e) {
              (this.criteria = $e({}, e.customCriteria)),
                (this.adTimings = new u(e.adTiming));
            }),
              ...
              if ("string" == typeof e.data.type)
                switch (e.data.type) {
                  ...
                  case "setPersonalizedADConsent":
                    this.toggleNonPersonalized(
                      !(e.data.content && e.data.content.consent)
                    ),
                      this.setConsentString(
                        e.data.content ? e.data.content.consentString : ""
                      );
                    break;
              ...
              o.addEventListener(n.ready, function () {
                ...
                o.addEventListener(n.ads.started, function () {
                  e.playerSkin.hideSpinner(),
                    e.callHandler("onStart", { type: n.ads.limit });
                }),
        ...
        return (
          (e.track = function (e, t) {
            if ((void 0 === t && (t = {}), -1 === st.indexOf(e)))
              throw new TypeError(
                "Invalid 'event', must be one of " + st.join(", ")
              );
            if ("object" != typeof t)
            ...
            if (null == i ? void 0 : i.vhbOnlyMode)
              switch (e) {
                ...
                case n.tracking.ads.video.loaderError:
                  z(
                    ot({ event: "video-adsloader-error", size: "640x360v" }, i)
                  );
                  break;
          ...
          (e.setupDefaultEvents = function () {
            var t,
              i =
                ...
                (t[n.ads.displayError] = console.log(
                  n.tracking.ads.status.displayError
                )),
          ...
          function t() {
            ...
            (this.gameStarted = !1),
              ...
              (this.logError = function (t) {
                At(t)
                  ? e.report(t)
                  : ut({ name: "logError", message: JSON.stringify(t) });
              }),
