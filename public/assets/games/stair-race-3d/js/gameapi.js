...
var detection = (function () {
  ...
  mod.detect = {
    ...
    androidStockBrowser: function () {
      if (
        mod.is.android &&
        mod.is.webkitVersion &&
        mod.is.webkitVersion < 537
      ) {
        return true;
      }
      return false;
    ...
    smartphone: function () {
      return ua.match(/Android.*Mobile|iPhone|IEMobile|WPDesktop|BB10/i)
        ? true
        : false;
    },
    tablet: function () {
...
fg_api.prototype.adsModule = function () {
  ...
  module.prototype.showClick2PlayOverlay = function (callback, force) {
    ...
    M.privacyInfo.innerHTML =
      self.translate("api.privacy_info") + self.translate("api.privacy_link");
    ...
    if (!(self.consent && self.consent.isPlatformLoaded())) {
      ...
      if (self.adapters) {
        self.adapters.add("consent", "platformLoaded", function () {
          if (!M.stageFooter) return;
          faZepto(M.stageFooter).css({
            opacity: "0",
            transition: "opacity 1s",
          });
          setTimeout(function () {
            if (M.stageFooter) M.stageFooter.style.visibility = "hidden";
          }, 1000);
        });
      }
    }
    ...
    function startVideoCallback() {
      ...
      if (!isInitialAd) self.spinner.show();
  ...
  module.prototype.showIMA = function (callback, force, controlSpinner) {
    ...
    if (controlSpinner) self.spinner.show();
    ...
    module.prototype.onAdEvent = function (adEvent) {
      ...
      switch (adEvent.type) {
        ...
        case google.ima.AdEvent.Type.STARTED:
          ...
          if (controlSpinner) self.spinner.hide();
  ...
  module.prototype.getAdTagUrl = function (variant, priceMode, waterfallID) {
    ...
    if (
      detection.is.iframe &&
      self.config.referrer_matched &&
      typeof ref == "string" &&
      !ref.endsWith("famobi.com")
    )
      descriptionUrl = ref;
    ...
    if (paramPriceRuleName) M.dfp_custom_params.pr = paramPriceRuleName;
    if (priceMode) M.dfp_custom_params.pm = priceMode;
    if (variant) M.dfp_custom_params.ab = variant;
    M.dfp_custom_params.wfid =
      typeof waterfallID == "number" && waterfallID > 0 ? "01" : "00";
    ...
    myAdTagUrl = myAdTagUrl.replace("[gdpr]", "0");
    ...
    if (descriptionUrl != "") {
      myAdTagUrl =
        myAdTagUrl + "&description_url=" + encodeURIComponent(descriptionUrl);
    }
    ...
    var opts = faZepto.extend(
      {
        ...
        returnCallback2: function () {
          var retVal = faZepto.extend({}, M.defaultReturnValue, {
...
fg_api.prototype.huaweiAdsModule = function () {
  ...
  module.prototype.showClick2PlayOverlay = function (callback) {
    ...
    Promise.race([self.wait(3000), Promise.all([documentLoaded, overlayReady])])
      .then(function () {
        self.rootElement.appendChild(M.playBtnContainer);
        // bugfix: wait a little after appending container so the following css transition will work
        return self.wait(33);
...
fg_api.prototype.showAd = function (callback, force, click2play_triggered) {
  if (this.ads.floodProtect("Show Ad", 1e3)) {
    if (typeof callback == "function") callback(this.ads.defaultReturnValue);
    return;
  }
...
fg_api.prototype.showInterstitialAd = function () {
  this.log(
    "showInterstitialAd: This feature is experimental and will be included in a future version of this API"
  );
...
fg_api.prototype.rewardedadsModule = function () {
  ...
  module.prototype.init = function () {
    ...
    if (
      urlParams.fg_env &&
      (urlParams.fg_env == "dev" || urlParams.fg_env == "staging")
    ) {
    ...
    function gptLoadedCallback() {
      ...
      window.googletag.cmd.push(function () {
        ...
        window.googletag
          .pubads()
          .setRequestNonPersonalizedAds(self.config.ads.npa ? 1 : 0);
    ...
    function setupGPTEventListeners() {
      ...
      window.googletag
        .pubads()
        .addEventListener("rewardedSlotCanceled", function () {
      ...
      window.googletag
        .pubads()
        .addEventListener("rewardedSlotCompleted", function () {
  ...
  module.prototype.initiateClosing = function () {
    ...
    if (M.rewardedAd.state == M.states.closing) return;
  ...
  module.prototype.showAd = function (callback) {
    ...
    M.preloadRewardedAd()
      ...
      .then(function () {
        if (M.rewardedAd.slot) M.rewardedAd.oldSlots.push(M.rewardedAd.slot);
  ...
  module.prototype.preloadRewardedAd = function () {
    if (!M.gptInitialized)
      return Promise.reject(
        new Error("preload cancelled: gpt not initialized")
      );
    ...
    if (
      ...
      return Promise.reject(
        new Error("preload cancelled: previous ad still active")
      );
    }
    ...
    if (
      ...
      if (M.rewardedAd.preloadPromise instanceof Promise)
        ...
        return Promise.reject(
          new Error("preload faulty: missing current preloader promise")
        );
    }
    ...
    if (M.preloadBlocked) {
      return Promise.reject(
        new Error("preload cancelled: too many failed attempts")
      );
    }
    ...
    M.rewardedAd.preloadPromise = new Promise(function (resolve, reject) {
      ...
      self.wait(M.TIMEOUT_BEFORE_PRELOAD_CANCELLED).then(function () {
        reject(
          new Error("preload cancelled: timeout while waiting for gpt events")
        );
      });
    });
...
fg_api.prototype.rewardedAd = function (callback) {
  if (
    this.rewardedads.floodProtect(
      "Rewarded Ad",
      this.rewardedads.TIMEOUT_FLOOD_PROTECTION
    )
  ) {
    if (typeof callback == "function")
...
fg_api.prototype.notifyModule = function () {
  ...
  module.prototype.setScrollAreaHeight = function () {
    ...
    var headerHeight =
      $header.height() + Number($header.css("margin-bottom").replace("px", ""));
...
fg_api.prototype.adaptersModule = function () {
  ...
  function module() {
    ...
    this.adapter_templates = {
      ...
      screenshot: {
        submit: [
          function (screenshot_url, options) {
            /**/
          },
        ],
      },
  ...
  adaptersPrototype.createAdapter = function (options) {
    return {
      ...
      queue: [],
      queueLength:
        options && typeof options.queueLength == "number"
          ? options.queueLength
          : undefined,
    ...
    if (adapter.queueCalls && adapter.queue.length > 0) {
      adapter.queue.forEach(function (args) {
        try {
          ...
          console.warn(
            "adapters.run: callback failed for",
            section + "." + subsection,
            "\n",
            err
          );
  ...
  adaptersPrototype.run = function (section, subsection) {
    ...
    if (adapter.runOnce && adapter.numRuns > 0) {
      console.warn(
        "adapters.run: one-time adapter called more than once for",
        section + "." + subsection,
        "\n"
      );
      return false;
    ...
    if (adapter.queueCalls) {
      ...
      if (
        typeof adapter.queueLength == "number" &&
...
fg_api.prototype.requestsModule = function () {
  ...
  requestsPrototype.onRequest = function (actionIdentifier, callback) {
    if (!self.adapters) {
      console.warn("onRequest(): adapters module required");
      return;
    }
  ...
  requestsPrototype.requestAction = function (actionIdentifier) {
    ...
    self.adapters.run.apply(
      self.adapters,
      ["request"].concat(Array.from(arguments))
    );
  };
...
fg_api.prototype.onRequest = function (action, callback) {
  if (!this.requests) {
    console.warn("onRequest(): requests module required");
    return;
  }
...
fg_api.prototype.consentModule = function () {
  ...
  function module() {
    ...
    if (self.debug) this.cookieproScriptID += "-test";
    this.cookieproScriptURL =
      "https://cookie-cdn.cookiepro.com/consent/[script_id]/otSDKStub.js";
    this.cmpLoaded = false;
    this.hidePlatformUIRequested = false;
  }

  module.prototype.init = function () {
    if (!self.hasFeature("ads") || self.config.ads.provider == "none") return;
  ...
  module.prototype.hidePlatformUI = function () {
    if (M.hidePlatformUIRequested) return;
...
fg_api.prototype.getFeatureProperties = function (feature) {
  return this.hasFeature(feature) &&
    typeof this.config.features[feature] == "object"
...
fg_api.prototype.socketModule = function () {
  ...
  module.prototype.init = function () {
    (function (d, s, id) {
      ...
      js.id = id;
      js.src = "//cdnjs.cloudflare.com/ajax/libs/socket.io/4.0.1/socket.io.js";
...
fg_api.prototype.highscoresModule = function () {
  ...
  module.prototype.submit = function (level, score, callback) {
    level =
      typeof level !== "undefined" && (level.length || level > 0) ? level : "0";
    score = Number(score);
    ...
    function listScores(opts) {
      ...
      faZepto(leaderBoardYouEntry)
        .find(".player em")
        .text(youData.name + (youData.name !== "Guest" ? "" : " (You)"));
      faZepto(leaderBoardYouEntry)
        .find(".score")
        .text(
...
fg_api.prototype.modalModule = function () {
  ...
  module.prototype.setCloseBtnTimer = function (sec, options) {
    ...
    M.closeBtnTimer = {
      autoclose:
        typeof options.autoclose == "undefined" ? true : options.autoclose,
      sec: sec,
...
fg_api.prototype.onOrientationChange = fg_api.prototype.onorientationchange =
  function (callback) {
    if (typeof callback !== "function") {
...
if (typeof window !== "undefined" && !window.famobi_tracking) {
  !(function (a, b) {
    ...
    function log() {
      if (tracking.debug) console.log.apply(this, arguments);
    }

    function initUser(preferredUid) {
      var storage = window.hasOwnProperty("famobi")
      ...
      if (
        ...
        return new Promise(function (resolve, reject) {
          ...
          window.famobi.getUrlParams()["original_ref"] &&
          ...
          if (
            preferredUid &&
            ((typeof preferredUid == "string" && preferredUid.length > 0) ||
              (typeof preferredUid == "number" && preferredUid > 0))
          ) {
    ...
    function init(game, preferredUid, clientVersion, debug, trackAds, runDry) {
      ...
      if (
        trackAds !== false &&
        window.hasOwnProperty("famobi") &&
        window.famobi.hasOwnProperty("adapters")
      ) {
    ...
    function trackEvent(event, data) {
      ...
      if (
        ...
        log(
          "tracking event cancelled - wrong/missing parameters",
          "eventPath",
          eventPath,
          "data",
          data
      ...
      if (tracking.initializedUser) processQueue();
    }
    ...
    function processQueue() {
      tracking.queue.forEach(function (queuedEvent) {
        tracking.currentPromise = tracking.currentPromise.then(
          function () {
  ...
  module.prototype.initializeFamobiTracking = function () {
    ...
    M.promise = new Promise(function (resolve, reject) {
      if (
        ...
        M.famobi_gameIDs.blocked.includes(window.famobi_gameID)
      ) {
      ...
      if (typeof window.famobi_tracking !== "undefined") {
        ...
        if (
          ...
          !M.famobi_gameIDs.supported.includes(window.famobi_gameID)
        ) {
          runDry = true;
        }
        ...
        try {
          window.famobi_tracking.init(
            M.famobi_gameIDs.mapping[window.famobi_gameID] ||
              window.famobi_gameID,
            null,
            0,
            debug,
        ...
        var pingInterval = setInterval(function () {
          try {
            setTimeout(function () {
              if (!M.isHidden) {
                window.famobi_tracking.trackEvent(
                  window.famobi_tracking.EVENTS.PING,
                  {}
                );
              } else {
                if (debug) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var paramsValidator = function () {
          ...
          if (
            ...
            // eslint-disable-next-line no-console
            console.warn(
              "trackEvent(): '" + event + "' requires at least one parameter"
            );
            return false;
          }
        ...
        if (famobi_analytics.TRIGGER_AD.indexOf(event) > -1) {
          if (
            "reason" in params &&
            (params["reason"] === "quit" || params["reason"] === "draw")
          ) {
        ...
        if (famobi_analytics.TRIGGER_CUSTOM.indexOf(event) > -1) {
          if (
            ...
            ["A-MONKEYGAMES-DEV"].includes(window.famobi.config.aid) &&
            ["archery-world-tour", "candy-bubble"].includes(
              window.famobi_gameID
            ) &&
            "eventName" in params &&
        ...
        if (famobi_analytics.TRIGGER_LEVELSCORE.indexOf(event) > -1) {
          return famobi
            .submitHighscore(params["levelName"], params["levelScore"])
            .then(function () {
              resolve(event, params);
            });
        }
    ...
    trackScreen: function (screen, pageTitle) {
      return new Promise(function (resolve, reject) {
        ...
        if (!pageTitle && screen.indexOf(requiredPageTitleScreens) > -1) {
          reject(
            "trackScreen(): screen '" + screen + "' requires param 'pageTitle'"
          );
          return false;
        }
...
fg_api.prototype.geoModule = function () {
  ...
  module.prototype.isEEA = function () {
    return new Promise(function (resolve, reject) {
      M.promise.then(function (geodata) {
        resolve(
          M.ISOCountryGroups.eea.indexOf(geodata.countryCode.toLowerCase()) > -1
        );
      }, reject);
    });
  };
...
fg_api.prototype.lsgModule = function () {
  ...
  module.prototype.init = function () {
    ...
    this.cpr_locales = ["at", "jp", "nl", "br", "gb", "tr"];
  };
        ...
        Promise.resolve(M.getLocale())
          .then(function (locale) {
            ...
            if (M.cpr_locales.indexOf(locale.toLowerCase()) > -1) {
              M.isActive(false);
              return Promise.reject(
                "Locale " + locale + " has custom price rules."
              );
...
fg_api.prototype.setVolume = function (volume) {
  if (!this.audio) {
    self.log("setVolume(): audio module required");
    return;
  }
...
fg_api.prototype.getVolume = function () {
  if (!this.audio) {
    self.log("getVolume(): audio module required");
    return 1;
  }
