    ...
    c.preRun.push(function () {
      c.addRunDependency("dataUrl"),
        o.then(function (n) {
          ...
          var n = decompress(Buffer.from(n));
          let t1 = performance.now();
          console.log(`Decompression DATA time: ${t1 - t0} milliseconds.`);
          var e = new DataView(n.buffer, n.byteOffset, n.byteLength),
            t = 0,
            a = "UnityWebData1.0\0";
          if (
            !String.fromCharCode.apply(null, n.subarray(t, t + a.length)) == a
          )
            throw "unknown data format";
          var r = e.getUint32((t += a.length), !0);
          for (t += 4; t < r; ) {
            var i = e.getUint32(t, !0),
              u = ((t += 4), e.getUint32(t, !0)),
              f = ((t += 4), e.getUint32(t, !0)),
              o =
                ((t += 4),
                String.fromCharCode.apply(null, n.subarray(t, t + f)));
            t += f;
            for (
              var l = 0, g = o.indexOf("/", l) + 1;
              0 < g;
              l = g, g = o.indexOf("/", l) + 1
            )
              c.FS_createPath(o.substring(0, l), o.substring(l, g - 1), !0, !0);
            c.FS_createDataFile(o, null, n.subarray(i, i + u), !0, !0, !0);
          }
