var x=Object.defineProperty;var v=(e,r,s)=>r in e?x(e,r,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[r]=s;var c=(e,r,s)=>(v(e,typeof r!="symbol"?r+"":r,s),s);import{t as y,r as f,e as h,u as j,j as t,L as k}from"./index-DC0BSc5F.js";import{g as w}from"./games-BRYhIBbN.js";import $ from"./_...all_-CMUIkUZX.js";var m=":host{align-items:center;display:inline-flex;flex-shrink:0;height:var(--uib-size);justify-content:center;width:var(--uib-size)}:host([hidden]){display:none}.container{animation:rotate var(--uib-speed) linear infinite;height:var(--uib-size);overflow:visible;transform-origin:center;width:var(--uib-size);will-change:transform}.car{stroke:var(--uib-color);stroke-dasharray:var(--uib-dash),var(--uib-gap);stroke-dashoffset:0;stroke-linecap:round}.car,.track{fill:none;transition:stroke .5s ease}.track{stroke:var(--uib-color);opacity:var(--uib-bg-opacity)}@keyframes rotate{to{transform:rotate(1turn)}}";class b extends y{constructor(){super();c(this,"_attributes",["size","color","speed","stroke","stroke-length","bg-opacity"]);c(this,"size");c(this,"color");c(this,"speed");c(this,"stroke");c(this,"stroke-length");c(this,"bg-opacity");this.storePropsToUpgrade(this._attributes),this.reflect(this._attributes)}static get observedAttributes(){return["size","color","stroke","stroke-length","speed","bg-opacity"]}connectedCallback(){this.upgradeStoredProps(),this.applyDefaultProps({size:40,color:"black",stroke:5,"stroke-length":.25,speed:.8,"bg-opacity":.1});const s=parseInt(this.size),n=parseInt(this.stroke),o=s/2,l=Math.max(0,s/2-n/2);this.template.innerHTML=`
      <svg
        class="container"
    ...
    `,this.shadow.replaceChildren(this.template.content.cloneNode(!0))}attributeChangedCallback(){const s=this.shadow.querySelector("style"),n=this.shadow.querySelector("svg"),o=this.shadow.querySelectorAll("circle");if(!s)return;const l=parseInt(this.size),i=parseInt(this.stroke),u=l/2,p=String(Math.max(0,l/2-i/2));n.setAttribute("height",this.size),n.setAttribute("width",this.size),n.setAttribute("viewBox",`${u} ${u} ${this.size} ${this.size}`),o.forEach(a=>{a.setAttribute("cx",this.size),a.setAttribute("cy",this.size),a.setAttribute("r",p),a.setAttribute("stroke-width",this.stroke)}),s.innerHTML=`
      :host{
        --uib-size: ${this.size}px;
        --uib-color: ${this.color};
        --uib-speed: ${this.speed}s;
