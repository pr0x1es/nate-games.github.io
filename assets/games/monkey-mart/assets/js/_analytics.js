  ...
  !(function (r) {
    ...
    (function (e) {
      ...
      ((n = e.EGAErrorSeverity || (e.EGAErrorSeverity = {}))[
        ...
        (l = e.events || (e.events = {})),
        ((u = l.EGASdkErrorCategory || (l.EGASdkErrorCategory = {}))[
          (u.Undefined = 0)
        ] = "Undefined"),
        ...
        (u[(u.Http = 4)] = "Http"),
        (u[(u.Json = 5)] = "Json"),
        ((c = l.EGASdkErrorArea || (l.EGASdkErrorArea = {}))[
          (c.Undefined = 0)
        ] = "Undefined"),
        ...
        ((v = l.EGASdkErrorAction || (l.EGASdkErrorAction = {}))[
          (v.Undefined = 0)
        ] = "Undefined"),
        ...
        ((g = l.EGASdkErrorParameter || (l.EGASdkErrorParameter = {}))[
          (g.Undefined = 0)
        ] = "Undefined"),
    ...
    (function (e) {
      ...
      (n = e.utilities || (e.utilities = {})),
        ...
        (u.encode64 = function (e) {
          e = encodeURI(e);
          for (
            var n, t, i, r, s, a = "", o = 0, d = 0, l = 0;
            (i = (n = e.charCodeAt(l++)) >> 2),
              (r = ((3 & n) << 4) | ((t = e.charCodeAt(l++)) >> 4)),
              (s = ((15 & t) << 2) | ((o = e.charCodeAt(l++)) >> 6)),
              (d = 63 & o),
        ...
        (u.decode64 = function (e) {
          ...
          for (
            ...
            (n =
              (u.keyStr.indexOf(e.charAt(d++)) << 2) |
              ((i = u.keyStr.indexOf(e.charAt(d++))) >> 4)),
              (t =
                ((15 & i) << 4) | ((r = u.keyStr.indexOf(e.charAt(d++))) >> 2)),
              (a = ((3 & r) << 6) | (o = u.keyStr.indexOf(e.charAt(d++)))),
              ...
              if (new RegExp(n[o].value, "i").test(e)) {
                if (
                  ...
                  for (d = 0; d < Math.min(l.length, 3); d += 1)
                    s += l[d] + (d < Math.min(l.length, 3) - 1 ? "." : "");
                } else s = "0.0.0";
                return (a.name = n[o].name), (a.version = s), a;
              }
            return a;
          }),
          (r.sdkWrapperVersion = "javascript 4.4.4"),
    ...
    (function (e) {
      ...
      (n = e.state || (e.state = {})),
        ...
        (g.getSdkConfig = function () {
          ...
          for (var t in ((n = 0), g.instance.sdkConfigCached))
            0 === n && (e = t), ++n;
          return e && 0 < n
            ? g.instance.sdkConfigCached
            : g.instance.sdkConfigDefault;
        }),
        ...
        (g.incrementProgressionTries = function (e) {
          ...
          (t.progression = e),
            (t.tries = n),
            d.insert(l.Progression, t, !0, "progression");
        }),
        (g.getProgressionTries = function (e) {
          return e in g.instance.progressionTries
            ? g.instance.progressionTries[e]
            : 0;
        }),
        (g.clearProgressionTries = function (e) {
          e in g.instance.progressionTries &&
            delete g.instance.progressionTries[e];
          var n = [];
        ...
        (g.setManualSessionHandling = function (e) {
          (g.instance.useManualSessionHandling = e),
            v.i("Use manual session handling: " + e);
        }),
        ...
        (g.getEventAnnotations = function () {
          ...
          return (
            ...
            g.instance.abVariantId &&
              (e.ab_variant_id = g.instance.abVariantId),
        ...
        (g.cacheIdentifier = function () {
          g.instance.userId
            ...
            : g.instance.defaultUserId &&
              (g.instance.identifier = g.instance.defaultUserId);
        }),
        (g.ensurePersistedStates = function () {
          d.isStorageAvailable() && d.load(g.getGameKey());
          var e = g.instance;
          e.setDefaultId(
            null != d.getItem(g.getGameKey(), g.DefaultUserIdKey)
              ? d.getItem(g.getGameKey(), g.DefaultUserIdKey)
              : c.createGuid()
          ),
            (e.sessionNum =
              null != d.getItem(g.getGameKey(), g.SessionNumKey)
                ? Number(d.getItem(g.getGameKey(), g.SessionNumKey))
                : 0),
            (e.transactionNum =
              null != d.getItem(g.getGameKey(), g.TransactionNumKey)
                ? Number(d.getItem(g.getGameKey(), g.TransactionNumKey))
                : 0),
            e.currentCustomDimension01
              ...
              : ((e.currentCustomDimension01 =
                  null != d.getItem(g.getGameKey(), g.Dimension01Key)
                    ? d.getItem(g.getGameKey(), g.Dimension01Key)
                    : ""),
                e.currentCustomDimension01),
            e.currentCustomDimension02
              ...
              : ((e.currentCustomDimension02 =
                  null != d.getItem(g.getGameKey(), g.Dimension02Key)
                    ? d.getItem(g.getGameKey(), g.Dimension02Key)
                    : ""),
                e.currentCustomDimension02),
            e.currentCustomDimension03
              ...
              : ((e.currentCustomDimension03 =
                  null != d.getItem(g.getGameKey(), g.Dimension03Key)
                    ? d.getItem(g.getGameKey(), g.Dimension03Key)
                    : ""),
                e.currentCustomDimension03);
          var n =
            null != d.getItem(g.getGameKey(), g.SdkConfigCachedKey)
              ? d.getItem(g.getGameKey(), g.SdkConfigCachedKey)
              : "";
          if (n) {
            ...
            for (var r in e) {
              ...
              if (r && s)
                if (i < g.MAX_CUSTOM_FIELDS_COUNT) {
                  var a = new RegExp(
                    "^[a-zA-Z0-9_]{1," + g.MAX_CUSTOM_FIELDS_KEY_LENGTH + "}$"
                  );
                  if (c.stringMatch(r, a)) {
                    var o = typeof s;
                    if ("string" == o || s instanceof String)
                      s.length <= g.MAX_CUSTOM_FIELDS_VALUE_STRING_LENGTH &&
                      0 < s.length
                        ? ((t[r] = s), ++i)
                        : ((u = g.formatString(
                            (l =
        ...
        (g.validateAndFixCurrentDimensions = function () {
          r.validateDimension01(
            g.getCurrentCustomDimension01(),
            g.getAvailableCustomDimensions01()
          ) || g.setCustomDimension01(""),
            r.validateDimension02(
              g.getCurrentCustomDimension02(),
              g.getAvailableCustomDimensions02()
            ) || g.setCustomDimension02(""),
            r.validateDimension03(
              g.getCurrentCustomDimension03(),
              g.getAvailableCustomDimensions03()
            ) || g.setCustomDimension03("");
        }),
        (g.getConfigurationStringValue = function (e, n) {
          return g.instance.configurations[e]
            ? g.instance.configurations[e].toString()
            : n;
        }),
        ...
        (g.addRemoteConfigsListener = function (e) {
          g.instance.remoteConfigsListeners.indexOf(e) < 0 &&
            g.instance.remoteConfigsListeners.push(e);
        }),
        ...
        (g.addOnBeforeUnloadListener = function (e) {
          g.instance.beforeUnloadListeners.indexOf(e) < 0 &&
            g.instance.beforeUnloadListeners.push(e);
        }),
        ...
        (g.notifyBeforeUnloadListeners = function () {
          for (
            var e = g.instance.beforeUnloadListeners, n = 0;
            n < e.length;
            ++n
          )
            e[n] && e[n].onBeforeUnload();
        }),
      ...
      (n = e.tasks || (e.tasks = {})),
        ...
        (l.execute = function (e, n, t, i) {
          ...
          if (
            ...
            3600 <= (r.getTime() - l.timestampMap[n].getTime()) / 1e3 &&
              ((l.timestampMap[n] = r), (l.countMap[n] = 0)),
      ...
      (u = e.http || (e.http = {})),
        ...
        (y.prototype.sendSdkErrorEvent = function (e, n, t, i, r, s, a) {
          if (
            ...
            h.validateSdkErrorEvent(s, a, e, n, t)
          ) {
            var o,
        ...
        (y.sendEventInArrayRequestCallback = function (e, n, t, i) {
          ...
          if (
            d == u.EGAHTTPApiResponse.Ok ||
            d == u.EGAHTTPApiResponse.Created ||
            d == u.EGAHTTPApiResponse.BadRequest
          ) {
            var l = r ? JSON.parse(r) : {};
            if (null == l)
              return (
                t(u.EGAHTTPApiResponse.JsonDecodeFailed, null, a, o),
    ...
    (function (E) {
      ...
      (g = E.events || (E.events = {})),
        ...
        (C.customEventFieldsErrorCallback = function (e, n) {
          if (S.isEventSubmissionEnabled()) {
            ...
            C.timestampMap[e] || (C.timestampMap[e] = t),
              ...
              3600 <= (t.getTime() - C.timestampMap[e].getTime()) / 1e3 &&
                ((C.timestampMap[e] = t), (C.countMap[e] = 0)),
              C.countMap[e] >= C.MAX_ERROR_COUNT ||
                E.threading.GAThreading.performTaskOnGAThread(function () {
                  C.addErrorEvent(E.EGAErrorSeverity.Warning, n, null, !0),
                    (C.countMap[e] = C.countMap[e] + 1);
                });
          }
        }),
        ...
        (C.addBusinessEvent = function (e, n, t, i, r, s, a) {
          if ((void 0 === r && (r = null), S.isEventSubmissionEnabled())) {
            ...
            if (null == o) {
              ...
              var l = {};
              if (s && 0 < Object.keys(s).length) for (var u in s) l[u] = s[u];
              else
                for (var u in S.instance.currentGlobalCustomEventFields)
                  l[u] = S.instance.currentGlobalCustomEventFields[u];
          ...
          if (S.isEventSubmissionEnabled()) {
            ...
            if (null == o) {
              ...
              (d.event_id = l + ":" + n + ":" + i + ":" + r),
                ...
                C.addDimensionsToEvent(d);
              var u = {};
              if (s && 0 < Object.keys(s).length) for (var c in s) u[c] = s[c];
              else
                for (var c in S.instance.currentGlobalCustomEventFields)
                  u[c] = S.instance.currentGlobalCustomEventFields[c];
              if (a && s && 0 < Object.keys(s).length)
                for (var c in S.instance.currentGlobalCustomEventFields)
        ...
        (C.addProgressionEvent = function (e, n, t, i, r, s, a, o) {
          if (S.isEventSubmissionEnabled()) {
            ...
            if (null == l) {
              ...
              var v = 0;
              s &&
                e != E.EGAProgressionStatus.Start &&
                (c.score = Math.round(r)),
                e === E.EGAProgressionStatus.Fail &&
              ...
              var g = {};
              if (a && 0 < Object.keys(a).length) for (var f in a) g[f] = a[f];
              else
            ...
            if (null == s) {
              ...
              if (i && 0 < Object.keys(i).length) for (var d in i) o[d] = i[d];
                ...
                for (var d in S.instance.currentGlobalCustomEventFields)
                  o[d] = S.instance.currentGlobalCustomEventFields[d];
              ...
              C.addCustomFieldsToEvent(
                ...
                h.i("Add DESIGN event: {eventId:" + e + ", value:" + n + "}"),
                C.addEventToStore(a);
            } else
              y.instance.sendSdkErrorEvent(
                s.category,
        ...
        (C.addErrorEvent = function (e, n, t, i, r) {
          if ((void 0 === r && (r = !1), S.isEventSubmissionEnabled())) {
            ...
            if (null == a) {
              ...
              if (
                ...
                if (t && 0 < Object.keys(t).length)
                  ...
                  for (var l in S.instance.currentGlobalCustomEventFields)
                    d[l] = S.instance.currentGlobalCustomEventFields[l];
              ...
              h.i("Add ERROR event: {severity:" + s + ", message:" + n + "}"),
                C.addEventToStore(o);
            } else
              y.instance.sendSdkErrorEvent(
                a.category,
          ...
          if (S.isEventSubmissionEnabled()) {
            ...
            if (null == v) {
              ...
              (g.category = C.CategoryAds),
                ...
                (g.ad_type = u),
                (g.ad_action = l),
                e == E.EGAAdAction.FailedShow &&
                  0 < c.length &&
                  (g.ad_fail_show_reason = c),
                !a ||
              ...
              if (o && 0 < Object.keys(o).length) for (var m in o) f[m] = o[m];
                ...
                for (var m in S.instance.currentGlobalCustomEventFields)
                  f[m] = S.instance.currentGlobalCustomEventFields[m];
              ...
              C.addCustomFieldsToEvent(
                ...
                h.i(
                  "Add AD event: {ad_sdk_name:" +
                    ...
                    ", ad_action:" +
                    l +
                    (e == E.EGAAdAction.FailedShow && 0 < c.length
                      ? ", ad_fail_show_reason:" + c
                      : "") +
                    (!a ||
                    (n != E.EGAAdType.RewardedVideo && n != E.EGAAdType.Video)
                      ? ""
        ...
        (C.processEvents = function (e, n) {
          if (S.isEventSubmissionEnabled())
            try {
              ...
              if (!a || 0 == a.length)
                return (
                  h.i("Event queue: No events to send"),
              ...
              if (a.length > C.MaxEventCount) {
                ...
                if (
                  ...
                  !(a = f.select(m.Events, i)))
                )
                  return;
                r.push(["client_ts", p.LessOrEqual, o]);
              }
              if (
                (h.i("Event queue: Sending " + a.length + " events."),
                !f.update(m.Events, s, r))
              )
                return;
              ...
              h.e("Error during ProcessEvents(): " + e.stack),
                y.instance.sendSdkErrorEvent(
        ...
        (C.processEventsCallback = function (e, n, t, i) {
          var r = [];
          if ((r.push(["status", p.Equal, t]), e === l.Ok))
            f.delete(m.Events, r), h.i("Event queue: " + i + " events sent.");
            ...
            if (n) {
              ...
              e === l.BadRequest && a.constructor === Array
                ? h.w(
                    "Event queue: " +
                      i +
                      " events sent. " +
                ...
                : h.w("Event queue: Failed to send events.");
        ...
        (C.addEventToStore = function (e) {
          if (S.isEventSubmissionEnabled())
            if (S.isInitialized())
              try {
                if (
                  f.isStoreTooLargeForEvents() &&
                  !A.stringMatch(e.category, /^(user|session_end|business)$/)
                )
                  return (
                    h.w("Database too large. Event has been blocked."),
                    void y.instance.sendSdkErrorEvent(
                ...
                (r.category = n.category),
                  ...
                  (r.event = A.encode64(JSON.stringify(n))),
                  f.insert(m.Events, r),
        ...
        (C.resourceFlowTypeToString = function (e) {
          return e == E.EGAResourceFlowType.Source ||
            e == E.EGAResourceFlowType[E.EGAResourceFlowType.Source]
            ? "Source"
            : e == E.EGAResourceFlowType.Sink ||
                e == E.EGAResourceFlowType[E.EGAResourceFlowType.Sink]
              ? "Sink"
              : "";
        }),
        (C.progressionStatusToString = function (e) {
          return e == E.EGAProgressionStatus.Start ||
            e == E.EGAProgressionStatus[E.EGAProgressionStatus.Start]
            ? "Start"
            : e == E.EGAProgressionStatus.Complete ||
                e == E.EGAProgressionStatus[E.EGAProgressionStatus.Complete]
              ? "Complete"
              : e == E.EGAProgressionStatus.Fail ||
                  e == E.EGAProgressionStatus[E.EGAProgressionStatus.Fail]
                ? "Fail"
                : "";
        }),
        (C.errorSeverityToString = function (e) {
          return e == E.EGAErrorSeverity.Debug ||
            e == E.EGAErrorSeverity[E.EGAErrorSeverity.Debug]
            ? "debug"
            : e == E.EGAErrorSeverity.Info ||
                e == E.EGAErrorSeverity[E.EGAErrorSeverity.Info]
              ? "info"
              : e == E.EGAErrorSeverity.Warning ||
                  e == E.EGAErrorSeverity[E.EGAErrorSeverity.Warning]
                ? "warning"
                : e == E.EGAErrorSeverity.Error ||
                    e == E.EGAErrorSeverity[E.EGAErrorSeverity.Error]
                  ? "error"
                  : e == E.EGAErrorSeverity.Critical ||
                      e == E.EGAErrorSeverity[E.EGAErrorSeverity.Critical]
                    ? "critical"
                    : "";
        }),
        (C.adActionToString = function (e) {
          return e == E.EGAAdAction.Clicked ||
            e == E.EGAAdAction[E.EGAAdAction.Clicked]
            ? "clicked"
            : e == E.EGAAdAction.Show || e == E.EGAAdAction[E.EGAAdAction.Show]
              ? "show"
              : e == E.EGAAdAction.FailedShow ||
                  e == E.EGAAdAction[E.EGAAdAction.FailedShow]
                ? "failed_show"
                : e == E.EGAAdAction.RewardReceived ||
                    e == E.EGAAdAction[E.EGAAdAction.RewardReceived]
                  ? "reward_received"
                  : "";
        }),
        (C.adErrorToString = function (e) {
          return e == E.EGAAdError.Unknown ||
            e == E.EGAAdError[E.EGAAdError.Unknown]
            ? "unknown"
            : e == E.EGAAdError.Offline ||
                e == E.EGAAdError[E.EGAAdError.Offline]
              ? "offline"
              : e == E.EGAAdError.NoFill ||
                  e == E.EGAAdError[E.EGAAdError.NoFill]
                ? "no_fill"
                : e == E.EGAAdError.InternalError ||
                    e == E.EGAAdError[E.EGAAdError.InternalError]
                  ? "internal_error"
                  : e == E.EGAAdError.InvalidRequest ||
                      e == E.EGAAdError[E.EGAAdError.InvalidRequest]
                    ? "invalid_request"
                    : e == E.EGAAdError.UnableToPrecache ||
                        e == E.EGAAdError[E.EGAAdError.UnableToPrecache]
                      ? "unable_to_precache"
                      : "";
        }),
        (C.adTypeToString = function (e) {
          return e == E.EGAAdType.Video || e == E.EGAAdType[E.EGAAdType.Video]
            ? "video"
            : e == E.EGAAdType.RewardedVideo ||
                e == E.EGAAdError[E.EGAAdType.RewardedVideo]
              ? "rewarded_video"
              : e == E.EGAAdType.Playable ||
                  e == E.EGAAdError[E.EGAAdType.Playable]
                ? "playable"
                : e == E.EGAAdType.Interstitial ||
                    e == E.EGAAdError[E.EGAAdType.Interstitial]
                  ? "interstitial"
                  : e == E.EGAAdType.OfferWall ||
                      e == E.EGAAdError[E.EGAAdType.OfferWall]
                    ? "offer_wall"
                    : e == E.EGAAdType.Banner ||
                        e == E.EGAAdError[E.EGAAdType.Banner]
                      ? "banner"
                      : "";
        }),
      ...
      var l = d.threading.GAThreading,
        ...
        n =
          ...
          (E.init = function () {
            if (
              (v.touch(),
              (E.methodMap.configureAvailableCustomDimensions01 =
                E.configureAvailableCustomDimensions01),
              (E.methodMap.configureAvailableCustomDimensions02 =
                E.configureAvailableCustomDimensions02),
              (E.methodMap.configureAvailableCustomDimensions03 =
                E.configureAvailableCustomDimensions03),
              (E.methodMap.configureAvailableResourceCurrencies =
                E.configureAvailableResourceCurrencies),
              (E.methodMap.configureAvailableResourceItemTypes =
                E.configureAvailableResourceItemTypes),
              (E.methodMap.configureBuild = E.configureBuild),
              (E.methodMap.configureSdkGameEngineVersion =
                E.configureSdkGameEngineVersion),
              (E.methodMap.configureGameEngineVersion =
                E.configureGameEngineVersion),
              ...
              (E.methodMap.setEnabledManualSessionHandling =
                E.setEnabledManualSessionHandling),
              (E.methodMap.setEnabledEventSubmission =
                E.setEnabledEventSubmission),
              ...
              (E.methodMap.setGlobalCustomEventFields =
                E.setGlobalCustomEventFields),
              ...
              (E.methodMap.addRemoteConfigsListener =
                E.addRemoteConfigsListener),
              (E.methodMap.removeRemoteConfigsListener =
                E.removeRemoteConfigsListener),
              (E.methodMap.getRemoteConfigsValueAsString =
                E.getRemoteConfigsValueAsString),
              (E.methodMap.isRemoteConfigsReady = E.isRemoteConfigsReady),
              (E.methodMap.getRemoteConfigsContentAsString =
                E.getRemoteConfigsContentAsString),
              (E.methodMap.addOnBeforeUnloadListener =
                E.addOnBeforeUnloadListener),
              (E.methodMap.removeOnBeforeUnloadListener =
                E.removeOnBeforeUnloadListener),
          ...
          (E.gaCommand = function () {
            ...
            0 < e.length &&
              ...
              (1 < e.length
                ? d.GameAnalytics.methodMap[e[0]].apply(
                    null,
          ...
          (E.addBusinessEvent = function (e, n, t, i, r, s, a) {
            if (
              ...
              l.performTaskOnGAThread(function () {
                E.isSdkReady(!0, !0, "Could not add business event") &&
                  m.addBusinessEvent(e, n, t, i, r, s, a);
              });
          }),
          (E.addResourceEvent = function (e, n, t, i, r, s, a) {
            if (
              ...
              l.performTaskOnGAThread(function () {
                E.isSdkReady(!0, !0, "Could not add resource event") &&
                  m.addResourceEvent(e, n, t, i, r, s, a);
              });
          }),
          ...
          (E.addErrorEvent = function (e, n, t, i) {
            if (
              ...
              l.performTaskOnGAThread(function () {
                E.isSdkReady(!0, !0, "Could not add error event") &&
                  m.addErrorEvent(e, n, t, i);
              });
          }),
          (E.addAdEventWithNoAdReason = function (e, n, t, i, r, s, a) {
            if (
              ...
              l.performTaskOnGAThread(function () {
                E.isSdkReady(!0, !0, "Could not add ad event") &&
                  m.addAdEvent(e, n, t, i, r, 0, !1, s, a);
              });
          }),
          ...
          (E.setEnabledInfoLog = function (e) {
            void 0 === e && (e = !1),
              l.performTaskOnGAThread(function () {
                e
                  ? (o.setInfoLog(e), o.i("Info logging enabled"))
                  : (o.i("Info logging disabled"), o.setInfoLog(e));
              });
          }),
          (E.setEnabledVerboseLog = function (e) {
            void 0 === e && (e = !1),
              l.performTaskOnGAThread(function () {
                e
                  ? (o.setVerboseLog(e), o.i("Verbose logging enabled"))
                  : (o.i("Verbose logging disabled"), o.setVerboseLog(e));
              });
          }),
          ...
          (E.setEnabledEventSubmission = function (e) {
            void 0 === e && (e = !1),
              l.performTaskOnGAThread(function () {
                e
                  ? (c.setEnabledEventSubmission(e),
                    o.i("Event submission enabled"))
                  : (o.i("Event submission disabled"),
                    c.setEnabledEventSubmission(e));
              });
          }),
          ...
          (E.setGlobalCustomEventFields = function (e) {
            void 0 === e && (e = {}),
              l.performTaskOnGAThread(function () {
                o.i("Set global custom event fields: " + JSON.stringify(e)),
                  (c.instance.currentGlobalCustomEventFields = e);
              });
          }),
          ...
          (E.getRemoteConfigsValueAsString = function (e, n) {
            return (
              void 0 === n && (n = null), c.getConfigurationStringValue(e, n)
            );
          }),
          ...
          (E.startNewSessionCallback = function (e, n) {
            if ((e !== g.Ok && e !== g.Created) || !n)
              e == g.Unauthorized
                ? (o.w("Initialize SDK failed - Unauthorized"),
                  (c.instance.initAuthorized = !1))
                : (e === g.NoResponse || e === g.RequestTimeout
                    ? o.i(
                        "Init call (session start) failed - no response. Could be offline or timeout."
                      )
                    : e === g.BadResponse ||
                        e === g.JsonEncodeFailed ||
                        e === g.JsonDecodeFailed
                      ? o.i(
              ...
              (c.instance.configsHash = n.configs_hash ? n.configs_hash : ""),
                ...
                (c.instance.abVariantId = n.ab_variant_id
                  ? n.ab_variant_id
                  : ""),
                u.setItem(
                  c.getGameKey(),
                  c.SdkConfigCachedKey,
                  f.encode64(JSON.stringify(n))
                ),
            ...
            if (
              ((c.instance.clientServerTimeOffset = c.getSdkConfig().time_offset
                ? c.getSdkConfig().time_offset
                : 0),
              c.populateConfigurations(c.getSdkConfig()),
              !c.isEnabled())
            )
              return (
                o.w("Could not start session: SDK is disabled."),
                void l.stopEventQueue()
              );
            l.ensureEventQueueIsRunning();
            var s = f.createGuid();
            (c.instance.sessionId = s),
              (c.instance.sessionStart = c.getClientTsAdjusted()),
              m.addSessionStartEvent();
            var a = l.getTimedBlockById(E.initTimedBlockId);
            null != a && (a.running = !1), (E.initTimedBlockId = -1);
          }),
          (E.resumeSessionAndStartQueue = function () {
            c.isInitialized() &&
              (o.i("Resuming session."),
              c.sessionIsStarted() || E.newSession());
          }),
              ...
              e && !c.isInitialized()
                ...
                : e && !c.isEnabled()
                  ...
                  : !(
                      e &&
                      !c.sessionIsStarted() &&
                      (n && o.w(t + "Session has not started yet"), 1)
                    )
            );
          }),
