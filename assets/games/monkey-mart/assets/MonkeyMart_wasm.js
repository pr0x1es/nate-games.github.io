...
var _htonl = (Module["_htonl"] = function () {
  return (_htonl = Module["_htonl"] = Module["asm"]["Bi"]).apply(
    null,
    arguments
  );
});
...
var _JSWriteDump = (Module["_JSWriteDump"] = function () {
  return (_JSWriteDump = Module["_JSWriteDump"] = Module["asm"]["Hi"]).apply(
    null,
    arguments
  );
});
var __get_tzname = (Module["__get_tzname"] = function () {
  return (__get_tzname = Module["__get_tzname"] = Module["asm"]["Ii"]).apply(
    null,
    arguments
  );
});
...
var stackSave = (Module["stackSave"] = function () {
  return (stackSave = Module["stackSave"] = Module["asm"]["Li"]).apply(
    null,
    arguments
  );
});
var stackRestore = (Module["stackRestore"] = function () {
  return (stackRestore = Module["stackRestore"] = Module["asm"]["Mi"]).apply(
    null,
    arguments
  );
});
var stackAlloc = (Module["stackAlloc"] = function () {
  return (stackAlloc = Module["stackAlloc"] = Module["asm"]["Ni"]).apply(
    null,
    arguments
  );
});
var _setThrew = (Module["_setThrew"] = function () {
  return (_setThrew = Module["_setThrew"] = Module["asm"]["Oi"]).apply(
    null,
    arguments
  );
});
var dynCall_jii = (Module["dynCall_jii"] = function () {
  return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["Pi"]).apply(
    null,
    arguments
  );
});
