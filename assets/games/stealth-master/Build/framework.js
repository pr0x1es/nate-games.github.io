function unityFramework(Module) {
  ...
  function createWasm() {
    ...
    function receiveInstance(instance, module) {
      ...
      Module["asm"] = exports;
      wasmMemory = Module["asm"]["_h"];
      updateGlobalBufferAndViews(wasmMemory.buffer);
      wasmTable = Module["asm"]["xi"];
    ...
    function syncLoadScript(url) {
      return new Promise((resolve, reject) => {
        ...
        script.async = false; // To load the script synchronously

        // Event handling for script loading
        script.onload = () => {
          console.log(`Successfully loaded script: ${url}`);
          resolve();
        };

        // Event handling for script loading failure
        script.onerror = () => {
    ...
    // Global variable to hold timings
    let globalTimings = {};
    ...
    async function instantiateAsync() {
      ...
      try {
        // Start timing for file fetching
        ...
        // End timing for file fetching
        let t1 = performance.now();
        timings.fetchTime = t1 - t0;
        console.log(`Fetch time: ${timings.fetchTime} milliseconds.`);

        // Load the decompression script
        await syncLoadScript("./Build/bundle.js");

        // Start timing for file decompression
        t0 = performance.now();

        // Decompress the Wasm binary
        var decompressedBuffer = decompress(Buffer.from(arrayBuffer));

        // End timing for file decompression
        t1 = performance.now();
        timings.decompressionWASMTime = t1 - t0;
        console.log(
          `Decompression WASM time: ${timings.decompressionWASMTime} milliseconds.`
        );

        // Start timing for Wasm instantiation
        t0 = performance.now();

        // Instantiate the Wasm module
        await WebAssembly.instantiate(decompressedBuffer, info).then(
          receiveInstantiationResult
        );

        // End timing for Wasm instantiation
        t1 = performance.now();
        timings.instantiationTime = t1 - t0;
        console.log(
          `Instantiation time: ${timings.instantiationTime} milliseconds.`
        );

        // Save timings to global variable
        window.globalTimings = timings;
      } catch (error) {
        // Handle errors
  ...
  function _YTGame_FirstFrameReady(onAudioChangeCallback, onPauseCallback) {
    ytgame.game.firstFrameReady();
    ytgame.system.onAudioEnabledChange((isAudioEnabled) => {
      dynCall("vi", onAudioChangeCallback, [isAudioEnabled]);
    });
    ytgame.system.onPause(() => {
      dynCall("vi", onPauseCallback, [true]);
    });
    ytgame.system.onResume(() => {
      dynCall("vi", onPauseCallback, [false]);
    });
  }
  function _YTGame_GameReady() {
    ytgame.game.gameReady();
  }
  function _YTGame_IsAudioEnabled() {
    return ytgame.system.isAudioEnabled();
  }
  function _YTGame_LoadData(gameLoadedCallback) {
    ytgame.game.loadData().then(
      (data) => {
        var bufferSize = lengthBytesUTF8(data) + 1;
        var buffer = _malloc(bufferSize);
        stringToUTF8(data, buffer, bufferSize);
        dynCall("vi", gameLoadedCallback, [buffer]);
      },
      (e) => {
        dynCall("vi", gameLoadedCallback, [0]);
      }
    );
  }
  function _YTGame_SaveData(data) {
    ytgame.game.saveData(UTF8ToString(data)).then(
      () => {},
      (e) => {}
    );
  }
  ...
  var asmLibraryArg = {
    Ce: _JS_Accelerometer_IsRunning,
    hb: _JS_Accelerometer_Start,
    Be: _JS_Accelerometer_Stop,
    He: _JS_Cursor_SetImage,
    ...
    Ue: _JS_WebRequest_Create,
    Ve: _JS_WebRequest_GetResponseMetaData,
    We: _JS_WebRequest_GetResponseMetaDataLengths,
    Xe: _JS_WebRequest_Release,
    Qe: _JS_WebRequest_Send,
    Se: _JS_WebRequest_SetRedirectLimit,
    Re: _JS_WebRequest_SetRequestHeader,
    Te: _JS_WebRequest_SetTimeout,
    Mh: _YTGame_FirstFrameReady,
    Lh: _YTGame_GameReady,
    Ih: _YTGame_IsAudioEnabled,
    Kh: _YTGame_LoadData,
    Jh: _YTGame_SaveData,
    ...
    Ch: ___cxa_find_matching_catch_4,
    ...
    L: ___sys_fcntl64,
    Ge: ___sys_fstat64,
    xe: ___sys_ftruncate64,
    wc: ___sys_getcwd,
    tc: ___sys_getdents64,
    hc: ___sys_getegid32,
    ic: ___sys_geteuid32,
    Gc: ___sys_getpeername,
    Nc: ___sys_getrusage,
    Xc: ___sys_getsockname,
    vd: ___sys_getsockopt,
    Bh: ___sys_getuid32,
    Za: ___sys_ioctl,
    Vc: ___sys_listen,
    Ac: ___sys_lstat64,
    ...
    Dc: ___sys_sendmsg,
    Tc: ___sys_sendto,
    Rc: ___sys_setsockopt,
    Fc: ___sys_shutdown,
    Ua: ___sys_socket,
    jb: ___sys_stat64,
    yh: ___sys_statfs64,
    zh: ___sys_truncate64,
    Lc: ___sys_uname,
    yc: ___sys_unlink,
    D: _abort,
    K: _clock,
    ...
    db: _dlopen,
    ae: _dlsym,
    ya: _emscripten_asm_const_int_sync_on_main_thread,
    Vd: _emscripten_cancel_main_loop,
    Td: _emscripten_clear_interval,
    ...
    nh: _glAttachShader,
    Jb: _glBeginQuery,
    dg: _glBeginTransformFeedback,
    pa: _glBindAttribLocation,
    mh: _glBindBuffer,
    Df: _glBindBufferBase,
    Bf: _glBindBufferRange,
    jh: _glBindFramebuffer,
    kh: _glBindRenderbuffer,
    wf: _glBindSampler,
    lh: _glBindTexture,
    ...
    dc: _glColorMask,
    bh: _glCompileShader,
    $g: _glCompressedTexImage2D,
    Rf: _glCompressedTexImage3D,
    ah: _glCompressedTexSubImage2D,
    Vf: _glCompressedTexSubImage3D,
    Gf: _glCopyBufferSubData,
    _g: _glCopyTexImage2D,
    cc: _glCopyTexSubImage2D,
    Zg: _glCreateProgram,
    Yg: _glCreateShader,
    Xg: _glCullFace,
    Wg: _glDeleteBuffers,
    ...
    Ff: _glDrawBuffers,
    Mg: _glDrawElements,
    Hf: _glDrawElementsInstanced,
    Ng: _glEnable,
    Kg: _glEnableVertexAttribArray,
    Kb: _glEndQuery,
    eg: _glEndTransformFeedback,
    Cb: _glFenceSync,
    Hg: _glFinish,
    Ig: _glFlush,
    ...
    uf: _glGenSamplers,
    Fg: _glGenTextures,
    _f: _glGenTransformFeedbacks,
    cg: _glGenVertexArrays,
    ...
    vh: _glGetAttribLocation,
    Je: _glGetBufferSubData,
    Bg: _glGetError,
    Ag: _glGetFramebufferAttachmentParameteriv,
    ph: _glGetIntegeri_v,
    qa: _glGetIntegerv,
    yf: _glGetInternalformativ,
    Eb: _glGetProgramBinary,
    sh: _glGetProgramInfoLog,
    U: _glGetProgramiv,
    gg: _glGetQueryObjectuiv,
    fg: _glGetQueryiv,
    Jg: _glGetRenderbufferParameteriv,
    yg: _glGetShaderInfoLog,
    _b: _glGetShaderPrecisionFormat,
    zg: _glGetShaderSource,
    rh: _glGetShaderiv,
    xg: _glGetString,
    Nf: _glGetStringi,
    wg: _glGetTexParameteriv,
    zf: _glGetUniformBlockIndex,
    Da: _glGetUniformIndices,
    da: _glGetUniformLocation,
    Zb: _glGetUniformiv,
    uh: _glGetVertexAttribiv,
    ...
    Ef: _glReadBuffer,
    ca: _glReadPixels,
    tg: _glRenderbufferStorage,
    Of: _glRenderbufferStorageMultisample,
    xf: _glSamplerParameteri,
    Xb: _glScissor,
    rg: _glShaderSource,
    sg: _glStencilFuncSeparate,
    pg: _glStencilMask,
    qg: _glStencilOpSeparate,
    ng: _glTexImage2D,
    Tf: _glTexImage3D,
    og: _glTexParameterf,
    Ja: _glTexParameteri,
    mg: _glTexParameteriv,
    Qf: _glTexStorage2D,
    Sf: _glTexStorage3D,
    lg: _glTexSubImage2D,
    Uf: _glTexSubImage3D,
    Wf: _glTransformFeedbackVaryings,
    Mb: _glUniform1fv,
    oa: _glUniform1i,
    Nb: _glUniform1iv,
    Ob: _glUniform1uiv,
    ...
    Ub: _glUniform4iv,
    Vb: _glUniform4uiv,
    Gb: _glUniformBlockBinding,
    Wb: _glUniformMatrix3fv,
    Ia: _glUniformMatrix4fv,
    Kf: _glUnmapBuffer,
    hg: _glUseProgram,
    th: _glValidateProgram,
    ig: _glVertexAttrib4f,
    jg: _glVertexAttrib4fv,
    Af: _glVertexAttribIPointer,
    kg: _glVertexAttribPointer,
    Lb: _glViewport,
    mc: invoke_dddi,
    Ph: invoke_ddiii,
    I: invoke_dii,
    ...
    H: invoke_iiiiiiiii,
    M: invoke_iiiiiiiiii,
    Sa: invoke_iiiiiiiiiii,
    sc: invoke_iiiiiiiiiiiii,
    ...
    t: invoke_viiiiii,
    A: invoke_viiiiiii,
    Gh: invoke_viiiiiiifiifii,
    F: invoke_viiiiiiii,
    Q: invoke_viiiiiiiii,
    rc: invoke_viiiiiiiiifi,
    ea: invoke_viiiiiiiiii,
    oc: invoke_viiiiiiiiiiii,
    od: invoke_viiiiij,
    zd: invoke_viiij,
    Fd: invoke_viij,
    Ad: invoke_viiji,
  ...
  var _SendMessage = (Module["_SendMessage"] = function () {
    return (_SendMessage = Module["_SendMessage"] = Module["asm"]["ci"]).apply(
      null,
      arguments
    );
  });
  ...
  var _main = (Module["_main"] = function () {
    return (_main = Module["_main"] = Module["asm"]["ei"]).apply(
      null,
      arguments
    );
  });
  ...
  var _htonl = (Module["_htonl"] = function () {
    return (_htonl = Module["_htonl"] = Module["asm"]["gi"]).apply(
      null,
      arguments
    );
  });
  var _htons = (Module["_htons"] = function () {
    return (_htons = Module["_htons"] = Module["asm"]["hi"]).apply(
      null,
      arguments
    );
  });
  var _ntohs = (Module["_ntohs"] = function () {
    return (_ntohs = Module["_ntohs"] = Module["asm"]["ii"]).apply(
      null,
      arguments
    );
  });
  var __get_tzname = (Module["__get_tzname"] = function () {
    return (__get_tzname = Module["__get_tzname"] = Module["asm"]["ji"]).apply(
      null,
      arguments
    );
  });
  ...
  var stackSave = (Module["stackSave"] = function () {
    return (stackSave = Module["stackSave"] = Module["asm"]["mi"]).apply(
      null,
      arguments
    );
  });
  var stackRestore = (Module["stackRestore"] = function () {
    return (stackRestore = Module["stackRestore"] = Module["asm"]["ni"]).apply(
      null,
      arguments
    );
  });
  var stackAlloc = (Module["stackAlloc"] = function () {
    return (stackAlloc = Module["stackAlloc"] = Module["asm"]["oi"]).apply(
      null,
      arguments
    );
  });
  var _setThrew = (Module["_setThrew"] = function () {
    return (_setThrew = Module["_setThrew"] = Module["asm"]["pi"]).apply(
      null,
      arguments
    );
  });
  ...
  var _malloc = (Module["_malloc"] = function () {
    return (_malloc = Module["_malloc"] = Module["asm"]["si"]).apply(
      null,
      arguments
    );
  });
  var _free = (Module["_free"] = function () {
    return (_free = Module["_free"] = Module["asm"]["ti"]).apply(
      null,
      arguments
    );
  });
  var _memalign = (Module["_memalign"] = function () {
    return (_memalign = Module["_memalign"] = Module["asm"]["ui"]).apply(
      null,
      arguments
    );
  });
  var _memset = (Module["_memset"] = function () {
    return (_memset = Module["_memset"] = Module["asm"]["vi"]).apply(
      null,
      arguments
    );
  });
  var _strlen = (Module["_strlen"] = function () {
    return (_strlen = Module["_strlen"] = Module["asm"]["wi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vii = (Module["dynCall_vii"] = function () {
    return (dynCall_vii = Module["dynCall_vii"] = Module["asm"]["zi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ii = (Module["dynCall_ii"] = function () {
    return (dynCall_ii = Module["dynCall_ii"] = Module["asm"]["Ai"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiii = (Module["dynCall_iiii"] = function () {
    return (dynCall_iiii = Module["dynCall_iiii"] = Module["asm"]["Bi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jiji = (Module["dynCall_jiji"] = function () {
    return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["Ci"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_i = (Module["dynCall_i"] = function () {
    return (dynCall_i = Module["dynCall_i"] = Module["asm"]["Ei"]).apply(
      null,
      arguments
    );
  });
  var dynCall_v = (Module["dynCall_v"] = function () {
    return (dynCall_v = Module["dynCall_v"] = Module["asm"]["Fi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vi = (Module["dynCall_vi"] = function () {
    return (dynCall_vi = Module["dynCall_vi"] = Module["asm"]["Gi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iii = (Module["dynCall_iii"] = function () {
    return (dynCall_iii = Module["dynCall_iii"] = Module["asm"]["Ki"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viii = (Module["dynCall_viii"] = function () {
    return (dynCall_viii = Module["dynCall_viii"] = Module["asm"]["Li"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiij = (Module["dynCall_iiij"] = function () {
    return (dynCall_iiij = Module["dynCall_iiij"] = Module["asm"]["Mi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iij = (Module["dynCall_iij"] = function () {
    return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["Qi"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jii = (Module["dynCall_jii"] = function () {
    return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["Si"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jiii = (Module["dynCall_jiii"] = function () {
    return (dynCall_jiii = Module["dynCall_jiii"] = Module["asm"]["Ui"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viij = (Module["dynCall_viij"] = function () {
    return (dynCall_viij = Module["dynCall_viij"] = Module["asm"]["Zi"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fii = (Module["dynCall_fii"] = function () {
    return (dynCall_fii = Module["dynCall_fii"] = Module["asm"]["_i"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dii = (Module["dynCall_dii"] = function () {
    return (dynCall_dii = Module["dynCall_dii"] = Module["asm"]["$i"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vidi = (Module["dynCall_vidi"] = function () {
    return (dynCall_vidi = Module["dynCall_vidi"] = Module["asm"]["aj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vifi = (Module["dynCall_vifi"] = function () {
    return (dynCall_vifi = Module["dynCall_vifi"] = Module["asm"]["bj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viji = (Module["dynCall_viji"] = function () {
    return (dynCall_viji = Module["dynCall_viji"] = Module["asm"]["cj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiji = (Module["dynCall_iiji"] = function () {
    return (dynCall_iiji = Module["dynCall_iiji"] = Module["asm"]["hj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ji = (Module["dynCall_ji"] = function () {
    return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["jj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiii = (Module["dynCall_fiii"] = function () {
    return (dynCall_fiii = Module["dynCall_fiii"] = Module["asm"]["qj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jjji = (Module["dynCall_jjji"] = function () {
    return (dynCall_jjji = Module["dynCall_jjji"] = Module["asm"]["xj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jdi = (Module["dynCall_jdi"] = function () {
    return (dynCall_jdi = Module["dynCall_jdi"] = Module["asm"]["yj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jijj = (Module["dynCall_jijj"] = function () {
    return (dynCall_jijj = Module["dynCall_jijj"] = Module["asm"]["Nj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vji = (Module["dynCall_vji"] = function () {
    return (dynCall_vji = Module["dynCall_vji"] = Module["asm"]["Pj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ifi = (Module["dynCall_ifi"] = function () {
    return (dynCall_ifi = Module["dynCall_ifi"] = Module["asm"]["Wj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_idi = (Module["dynCall_idi"] = function () {
    return (dynCall_idi = Module["dynCall_idi"] = Module["asm"]["Xj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_diii = (Module["dynCall_diii"] = function () {
    return (dynCall_diii = Module["dynCall_diii"] = Module["asm"]["$j"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fffi = (Module["dynCall_fffi"] = function () {
    return (dynCall_fffi = Module["dynCall_fffi"] = Module["asm"]["ak"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jji = (Module["dynCall_jji"] = function () {
    return (dynCall_jji = Module["dynCall_jji"] = Module["asm"]["bk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iidi = (Module["dynCall_iidi"] = function () {
    return (dynCall_iidi = Module["dynCall_iidi"] = Module["asm"]["ek"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iifi = (Module["dynCall_iifi"] = function () {
    return (dynCall_iifi = Module["dynCall_iifi"] = Module["asm"]["fk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dji = (Module["dynCall_dji"] = function () {
    return (dynCall_dji = Module["dynCall_dji"] = Module["asm"]["ik"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iji = (Module["dynCall_iji"] = function () {
    return (dynCall_iji = Module["dynCall_iji"] = Module["asm"]["jk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vfi = (Module["dynCall_vfi"] = function () {
    return (dynCall_vfi = Module["dynCall_vfi"] = Module["asm"]["xk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ifiifii = (Module["dynCall_ifiifii"] = function () {
    return (dynCall_ifiifii = Module["dynCall_ifiifii"] =
      Module["asm"]["Lk"]).apply(null, arguments);
  });
  ...
  var dynCall_fifffii = (Module["dynCall_fifffii"] = function () {
    return (dynCall_fifffii = Module["dynCall_fifffii"] =
  ...
  var dynCall_vijfi = (Module["dynCall_vijfi"] = function () {
    return (dynCall_vijfi = Module["dynCall_vijfi"] =
      Module["asm"]["jl"]).apply(null, arguments);
  });
  var dynCall_ffi = (Module["dynCall_ffi"] = function () {
    return (dynCall_ffi = Module["dynCall_ffi"] = Module["asm"]["kl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijii = (Module["dynCall_ijii"] = function () {
    return (dynCall_ijii = Module["dynCall_ijii"] = Module["asm"]["rl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fiffifi = (Module["dynCall_fiffifi"] = function () {
    return (dynCall_fiffifi = Module["dynCall_fiffifi"] =
  ...
  var dynCall_ifii = (Module["dynCall_ifii"] = function () {
    return (dynCall_ifii = Module["dynCall_ifii"] = Module["asm"]["xl"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iffii = (Module["dynCall_iffii"] = function () {
    return (dynCall_iffii = Module["dynCall_iffii"] =
  ...
  var dynCall_iifffii = (Module["dynCall_iifffii"] = function () {
    return (dynCall_iifffii = Module["dynCall_iifffii"] =
  ...
  var dynCall_iiiifiiiiifii = (Module["dynCall_iiiifiiiiifii"] = function () {
    return (dynCall_iiiifiiiiifii = Module["dynCall_iiiifiiiiifii"] =
      Module["asm"]["Kl"]).apply(null, arguments);
  });
  var dynCall_iiifiiiiifii = (Module["dynCall_iiifiiiiifii"] = function () {
    return (dynCall_iiifiiiiifii = Module["dynCall_iiifiiiiifii"] =
      Module["asm"]["Ll"]).apply(null, arguments);
  });
  var dynCall_viiifiiiiifii = (Module["dynCall_viiifiiiiifii"] = function () {
    return (dynCall_viiifiiiiifii = Module["dynCall_viiifiiiiifii"] =
      Module["asm"]["Ml"]).apply(null, arguments);
  });
  ...
  var dynCall_iiiifiifi = (Module["dynCall_iiiifiifi"] = function () {
    return (dynCall_iiiifiifi = Module["dynCall_iiiifiifi"] =
      Module["asm"]["Pl"]).apply(null, arguments);
  });
  ...
  var dynCall_iiiifiiifi = (Module["dynCall_iiiifiiifi"] = function () {
    return (dynCall_iiiifiiifi = Module["dynCall_iiiifiiifi"] =
      Module["asm"]["Rl"]).apply(null, arguments);
  });
  var dynCall_iiiiiiiiifii = (Module["dynCall_iiiiiiiiifii"] = function () {
    return (dynCall_iiiiiiiiifii = Module["dynCall_iiiiiiiiifii"] =
      Module["asm"]["Sl"]).apply(null, arguments);
  });
  ...
  var dynCall_iiifiifi = (Module["dynCall_iiifiifi"] = function () {
    return (dynCall_iiifiifi = Module["dynCall_iiifiifi"] =
      Module["asm"]["Vl"]).apply(null, arguments);
  });
  ...
  var dynCall_iiifiiifi = (Module["dynCall_iiifiiifi"] = function () {
    return (dynCall_iiifiiifi = Module["dynCall_iiifiiifi"] =
  ...
  var dynCall_viiifiifi = (Module["dynCall_viiifiifi"] = function () {
    return (dynCall_viiifiifi = Module["dynCall_viiifiifi"] =
  ...
  var dynCall_viiifiiifi = (Module["dynCall_viiifiiifi"] = function () {
    return (dynCall_viiifiiifi = Module["dynCall_viiifiiifi"] =
  ...
  var dynCall_idii = (Module["dynCall_idii"] = function () {
    return (dynCall_idii = Module["dynCall_idii"] = Module["asm"]["Fm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iddi = (Module["dynCall_iddi"] = function () {
    return (dynCall_iddi = Module["dynCall_iddi"] = Module["asm"]["Km"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iffi = (Module["dynCall_iffi"] = function () {
    return (dynCall_iffi = Module["dynCall_iffi"] = Module["asm"]["Ym"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ffii = (Module["dynCall_ffii"] = function () {
    return (dynCall_ffii = Module["dynCall_ffii"] = Module["asm"]["$m"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ddi = (Module["dynCall_ddi"] = function () {
    return (dynCall_ddi = Module["dynCall_ddi"] = Module["asm"]["bn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viiiiififi = (Module["dynCall_viiiiififi"] = function () {
    return (dynCall_viiiiififi = Module["dynCall_viiiiififi"] =
      Module["asm"]["fn"]).apply(null, arguments);
  });
  var dynCall_viiiiiififi = (Module["dynCall_viiiiiififi"] = function () {
    return (dynCall_viiiiiififi = Module["dynCall_viiiiiififi"] =
  ...
  var dynCall_jidi = (Module["dynCall_jidi"] = function () {
    return (dynCall_jidi = Module["dynCall_jidi"] = Module["asm"]["yn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_diji = (Module["dynCall_diji"] = function () {
    return (dynCall_diji = Module["dynCall_diji"] = Module["asm"]["zn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fidi = (Module["dynCall_fidi"] = function () {
    return (dynCall_fidi = Module["dynCall_fidi"] = Module["asm"]["An"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vffi = (Module["dynCall_vffi"] = function () {
    return (dynCall_vffi = Module["dynCall_vffi"] = Module["asm"]["Kn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiiififiiii = (Module["dynCall_iiiififiiii"] = function () {
    return (dynCall_iiiififiiii = Module["dynCall_iiiififiiii"] =
      Module["asm"]["_n"]).apply(null, arguments);
  });
  var dynCall_iiiifiifiii = (Module["dynCall_iiiifiifiii"] = function () {
    return (dynCall_iiiifiifiii = Module["dynCall_iiiifiifiii"] =
  ...
  var dynCall_vjii = (Module["dynCall_vjii"] = function () {
    return (dynCall_vjii = Module["dynCall_vjii"] = Module["asm"]["no"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jfi = (Module["dynCall_jfi"] = function () {
    return (dynCall_jfi = Module["dynCall_jfi"] = Module["asm"]["cp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fji = (Module["dynCall_fji"] = function () {
    return (dynCall_fji = Module["dynCall_fji"] = Module["asm"]["dp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fdi = (Module["dynCall_fdi"] = function () {
    return (dynCall_fdi = Module["dynCall_fdi"] = Module["asm"]["ep"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dfi = (Module["dynCall_dfi"] = function () {
    return (dynCall_dfi = Module["dynCall_dfi"] = Module["asm"]["fp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ddii = (Module["dynCall_ddii"] = function () {
    return (dynCall_ddii = Module["dynCall_ddii"] = Module["asm"]["tp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jdii = (Module["dynCall_jdii"] = function () {
    return (dynCall_jdii = Module["dynCall_jdii"] = Module["asm"]["zp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_didi = (Module["dynCall_didi"] = function () {
    return (dynCall_didi = Module["dynCall_didi"] = Module["asm"]["Dp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_di = (Module["dynCall_di"] = function () {
    return (dynCall_di = Module["dynCall_di"] = Module["asm"]["Mp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viif = (Module["dynCall_viif"] = function () {
    return (dynCall_viif = Module["dynCall_viif"] = Module["asm"]["Yp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fff = (Module["dynCall_fff"] = function () {
    return (dynCall_fff = Module["dynCall_fff"] = Module["asm"]["Zp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vif = (Module["dynCall_vif"] = function () {
    return (dynCall_vif = Module["dynCall_vif"] = Module["asm"]["_p"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viff = (Module["dynCall_viff"] = function () {
    return (dynCall_viff = Module["dynCall_viff"] = Module["asm"]["eq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vij = (Module["dynCall_vij"] = function () {
    return (dynCall_vij = Module["dynCall_vij"] = Module["asm"]["fq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ijj = (Module["dynCall_ijj"] = function () {
    return (dynCall_ijj = Module["dynCall_ijj"] = Module["asm"]["gq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vjji = (Module["dynCall_vjji"] = function () {
    return (dynCall_vjji = Module["dynCall_vjji"] = Module["asm"]["hq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ij = (Module["dynCall_ij"] = function () {
    return (dynCall_ij = Module["dynCall_ij"] = Module["asm"]["iq"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iif = (Module["dynCall_iif"] = function () {
    return (dynCall_iif = Module["dynCall_iif"] = Module["asm"]["Fq"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vf = (Module["dynCall_vf"] = function () {
    return (dynCall_vf = Module["dynCall_vf"] = Module["asm"]["Nq"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vff = (Module["dynCall_vff"] = function () {
    return (dynCall_vff = Module["dynCall_vff"] = Module["asm"]["Pq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vfff = (Module["dynCall_vfff"] = function () {
    return (dynCall_vfff = Module["dynCall_vfff"] = Module["asm"]["Qq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iiff = (Module["dynCall_iiff"] = function () {
    return (dynCall_iiff = Module["dynCall_iiff"] = Module["asm"]["Rq"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_f = (Module["dynCall_f"] = function () {
    return (dynCall_f = Module["dynCall_f"] = Module["asm"]["Tq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ff = (Module["dynCall_ff"] = function () {
    return (dynCall_ff = Module["dynCall_ff"] = Module["asm"]["Uq"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiiififiii = (Module["dynCall_iiiififiii"] = function () {
    return (dynCall_iiiififiii = Module["dynCall_iiiififiii"] =
      Module["asm"]["Xq"]).apply(null, arguments);
  });
  ...
  var dynCall_fiif = (Module["dynCall_fiif"] = function () {
    return (dynCall_fiif = Module["dynCall_fiif"] = Module["asm"]["Zq"]).apply(
      null,
      arguments
    );
  });
  ...
  function invoke_ifiifii(index, a1, a2, a3, a4, a5, a6) {
    var sp = stackSave();
    try {
      return dynCall_ifiifii(index, a1, a2, a3, a4, a5, a6);
    } catch (e) {
      stackRestore(sp);
      if (e !== e + 0 && e !== "longjmp") throw e;
      _setThrew(1, 0);
