...
\*****************************/ /*!no static exports found*/ function (
    ...
    const mainScene_1 = __importDefault(
      __webpack_require__(
        /*!./scenes/mainScene*/ "./src/scripts/scenes/mainScene.js"
      )
    );
    const preloadScene_1 = __importDefault(
      __webpack_require__(
        /*!./scenes/preloadScene*/ "./src/scripts/scenes/preloadScene.js"
      )
    );
    const preLoadingScene_1 = __importDefault(
      __webpack_require__(
        /*!./scenes/preLoadingScene*/ "./src/scripts/scenes/preLoadingScene.js"
      )
    );
    const config = Object.assign(
      {
        ...
        scene: [
          preLoadingScene_1.default,
          preloadScene_1.default,
          mainScene_1.default,
        ],
...
\******************************************/ /*!exports provided: default*/ function (
      ...
      var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(
          /*!@enable3d/phaser-extension*/ "./node_modules/@enable3d/phaser-extension/dist/index.js"
        );
      var _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0___default =
      ...
      class Blade {
        constructor(scene) {
          ...
          for (let i = 0; i < 10; i++) {
            let sliceEffect = new this.SliceEffect(
              this.scene,
              0,
              0,
              "SliceDiamondNeutral"
          ...
          for (let i = 0; i < 10; i++) {
            let sliceCriticalEffect = new this.SliceCriticalEffect(
              this.scene,
              0,
              0
            );
        ...
        createBlade(trail, points, maxHeight, color) {
          ...
          if (points.length > lastPos) {
            ...
            var count = 0;
            for (
              var index = points.length - lastPos;
              index < points.length;
              ++index
            ) {
              var point = points[index];
        ...
        updateBlade(delta) {
                ...
                if (distance > 50 && !playAny && this.lastTimeStamp <= 0) {
                  if (!this.scene.SFXMuted) {
                    this.scene.sound.play(
                      "BladeRegularSwipe0" + Phaser.Math.Between(1, 7)
                    );
                  }
          ...
          for (let i = 0; i < this.activeSliceCriticalEffect.length; i++) {
            if (this.activeSliceCriticalEffect[i].visible == false) {
              this.poolSliceCriticalEffect.push(
                this.activeSliceCriticalEffect[i]
              );
        ...
        checkFruits(fruitFactory) {
          ...
          for (var i = 1; i < points.length; i++) {
            ...
            listFruits.forEach((fruitObj) => {
              if (fruitObj.active) {
                let posFruit = this.scene.third.transform.from3dto2d(
                  fruitObj.object.position
                );
                let fruit = {
                  x: posFruit.x,
                  y: posFruit.y,
                ...
                if (this.checkIntersects(fruit, line)) {
                  ...
                  let resSlice = this.scene.fruitFactory.slice(
                    fruitObj,
                    degree
                  );
                  if (resSlice != -1) {
              ...
              if (fruitObj.active && res == "") {
                ...
                if (followMe == "classic") {
                  if (this.checkIntersects(fruit, modifiedLine, "WMUI")) {
                    ...
                    if (
                      res == "" &&
                      this.scene.fruitFactory.slice(fruitObj, degree) != -1
                    ) {
                      res = fruitObj.id;
                    }
                  }
...
\**********************************************/ /*!exports provided: default*/ function (
      ...
      class ComboText extends Phaser.GameObjects.Container {
        constructor(scene, x, y) {
          ...
          let gradient = this.textAtas.context.createLinearGradient(
            0,
            0,
            0,
            this.textAtas.height
          );
          ...
          this.textTengah = this.scene.add.text(
            0,
            this.textAtas.height / 2 + 30,
            "Combo",
            {
              fontFamily: "gangofchinese",
              fontSize: 60,
          ...
          gradient = this.textTengah.context.createLinearGradient(
            0,
            0,
            0,
            this.textTengah.height
          );
          gradient.addColorStop(0, "#FEDB3D");
          ...
          gradient = this.textBawah.context.createLinearGradient(
            0,
            0,
            0,
          ...
          gradient = this.textAtas2.context.createLinearGradient(
            0,
            0,
            0,
            this.textAtas2.height
          );
          ...
          gradient = this.textAtas3.context.createLinearGradient(
            0,
            0,
            0,
            this.textAtas3.height
          );
          ...
          this.textTengah2 = this.scene.add.text(
            0,
            this.textAtas.height / 2 + 30,
            "Combo",
            {
          ...
          gradient = this.textTengah2.context.createLinearGradient(
            0,
            0,
            0,
            this.textTengah2.height
          );
          gradient.addColorStop(0, "#FF9936");
          ...
          this.textTengah3 = this.scene.add.text(
            0,
            this.textAtas.height / 2 + 30,
            "Combo",
            {
          ...
          gradient = this.textTengah3.context.createLinearGradient(
            0,
            0,
            0,
            this.textTengah3.height
          );
          gradient.addColorStop(0, "#FE7838");
          ...
          gradient = this.textBawah2.context.createLinearGradient(
            0,
            0,
            0,
            this.textBawah2.height
          );
          gradient.addColorStop(0, "#FF9936");
          gradient.addColorStop(0.5, "#FFE264");
          gradient.addColorStop(0.5, "#E17C2F");
          ...
          gradient = this.textBawah3.context.createLinearGradient(
            0,
            0,
            0,
            this.textBawah3.height
          );
          gradient.addColorStop(0, "#FE7838");
          gradient.addColorStop(0.5, "#FFBA93");
          gradient.addColorStop(0.5, "#EF562F");
      ...
      class CriticalText extends Phaser.GameObjects.Container {
        constructor(scene, x, y) {
          ...
          this.textBawah.setPosition(
            0,
            this.textAtas.y +
              this.textAtas.height / 2 +
              this.textBawah.height / 2 -
              25
          );
          this.add(this.textAtas);
          this.add(this.textBawah);
...
\*************************************************/ /*!exports provided: default*/ function (
      ...
      (function (global) {
        ...
        class FruitFactory {
          ...
          async create() {
            this.fruitTexture = await this.scene.third.load.texture(
              "fruits_tex"
            );
            this.shadowTexture = await this.scene.third.load.texture(
              "fruit_shadow"
            );
            this.bombTexture = await this.scene.third.load.texture("bomb_tex");
            this.bombRayTexture = await this.scene.third.load.texture(
              "bomb_ray_tex"
            );
            this.splashTexture = await this.scene.third.load.texture(
              "splash_tex"
            );
            this.splashTexture2 = await this.scene.third.load.texture(
              "splash2_tex"
            );
            this.splashTexture3 = await this.scene.third.load.texture(
              "splash3_tex"
            );
            this.splashTexture4 = await this.scene.third.load.texture(
              "splash4_tex"
            );
            this.splashSliced1 = await this.scene.third.load.texture(
              "SplashSlice1"
            );
            this.splashSliced2 = await this.scene.third.load.texture(
              "SplashSlice2"
            );
            this.fruitTrailTex = await this.scene.third.load.texture(
              "FruitTrail"
            );
            this.criticalTrailTex = await this.scene.third.load.texture(
              "CriticalTrail"
            );
            this.bombTrailTex = await this.scene.third.load.texture(
              "BombTrail"
            );
            this.bombSmokeTex = await this.scene.third.load.texture(
              "BombSmoke"
            );
            this.helperVec3 =
            ...
            this.emitterDroplets["JuiceDragonFruit"] =
              this.createEmitter("JuiceDragonfruit");
            this.emitterDroplets["JuiceGreen"] =
              this.createEmitter("JuiceGreen");
            this.emitterDroplets["JuiceMango"] =
              this.createEmitter("JuiceMango");
            this.emitterDroplets["JuiceOrange"] =
              this.createEmitter("JuiceOrange");
            this.emitterDroplets["JuicePineapple"] =
              this.createEmitter("JuicePineapple");
            this.emitterDroplets["JuiceRed"] = this.createEmitter("JuiceRed");
            this.emitterDroplets["StarCritical"] = this.createEmitter(
              "StarCritical",
              1.0
            );
            this.emitterDroplets2 = {};
            this.emitterDroplets2["JuiceDragonFruit"] = this.createEmitter(
              "JuiceDragonfruit",
              1
            );
            this.emitterDroplets2["JuiceGreen"] = this.createEmitter(
              "JuiceGreen",
              1
            );
            this.emitterDroplets2["JuiceMango"] = this.createEmitter(
              "JuiceMango",
              1
            );
            this.emitterDroplets2["JuiceOrange"] = this.createEmitter(
              "JuiceOrange",
              1
            );
            this.emitterDroplets2["JuicePineapple"] = this.createEmitter(
              "JuicePineapple",
              1
            );
            this.emitterDroplets2["JuiceRed"] = this.createEmitter(
              "JuiceRed",
              1
            );
            this.bombRay = [];
          ...
          populateRayForBomb(bomb) {
            ...
            for (let i = 0; i < nRay; i++) {
              this.scene.third.load
                .fbx("assets/effects/PomegranateRay.fbx")
                .then((object) => {
            ...
            this.scene.third.load.fbx(path).then((object) => {
              ...
              object.traverse(function (child) {
                if (child.isMesh) {
                  ...
                  if (
                    child.name.includes("Half") ||
                    child.name.includes("half")
                  ) {
                    child.visible = false;
                    child.firstLoad = true;
                    if (
                      child.name.includes("Half1") ||
                      child.name.includes("half1")
                    ) {
              ...
              if (fruit.id == "Bomb" || fruit.id == "BUI") {
                ...
                if (fruit.hasSplash) {
                  ...
                  if (fruit.critical) {
                    ...
                    this.emitterDroplets["StarCritical"].angle.start =
                      curAngle - 15;
                    this.emitterDroplets["StarCritical"].angle.end =
                      curAngle + 15;
                    this.emitterDroplets["StarCritical"].emitParticleAt(
                      posFruit.x,
                      posFruit.y
                    );
                    this.emitterDroplets2[fruit.droplets].emitParticleAt(
                      posFruit.x,
                      posFruit.y
                    );
                  } else {
                    if (fruit.id != "AppleGreen") {
                      let curAngle = -sliceDirection;
                      this.emitterDroplets[fruit.droplets].angle.start =
                        curAngle - 15;
                      this.emitterDroplets[fruit.droplets].angle.end =
                        curAngle + 15;
                      this.emitterDroplets[fruit.droplets].emitParticleAt(
                        posFruit.x,
                        posFruit.y
                      );
                    }
                  ...
                  let nSplat = Phaser.Math.Between(
                    fruit.minSplash,
                    fruit.maxSplash
                  );
                  if (fruit.critical) {
                  ...
                  for (let a = 0; a < nSplat; a++) {
                    ...
                    if (splashId == 6 || splashId == 7) {
                      fruit.splash[splashId].rotation.set(
                        0,
                        0,
                        (sliceDirection * Math.PI) / 180
                      );
                    }
                    ...
                    if (splashId == 6 || splashId == 7) {
                      let xGeser =
                        Math.cos((sliceDirection * Math.PI) / 180) / 2;
                      let yGeser =
                        Math.sin((sliceDirection * Math.PI) / 180) / 2;
                      tmpPos.x += xGeser;
                      tmpPos.y += yGeser;
                    } else {
                      ...
                      this.scene.tweens.add({
                        ...
                        delay: 2000,
                        onUpdate: () => {
                          fruit.splash[splashId].position.set(
                            tmpPos.x,
                            tmpPos.y,
                            tmpPos.z
                          );
          ...
          activate(fruit) {
            ...
            fruit.active = true;
            if (fruit.hasSplash) {
              fruit.splash[0].material.color.alpha =
                fruit.splash[0].material.color.baseAlpha;
              fruit.splash[0].material.opacity =
                fruit.splash[0].material.color.alpha;
            }
          }
          deactivate(fruit) {
            ...
            if (!fruit.sliced && fruit.id != "Bomb" && fruit.id != "BUI") {
              let posX = this.scene.third.transform.from3dto2d(
                fruit.object.position
              ).x;
              if (fruit.pastScreen) {
            ...
            this.listFruits.forEach((fruit) => {
              ...
              if (fruit.active) {
                ...
                if (fruit.object.position.y < -2) {
                  ...
                  if (fruit.sliced) {
                    let half1 = fruit.object.getObjectByName(
                      fruit.id + "Half1"
                    );
                    let half2 = fruit.object.getObjectByName(
                      fruit.id + "Half2"
                    );
                    if (half1 && half2) {
...
\*****************************************/ /*!exports provided: default*/ function (
      ...
      class MainScene extends _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__[
        "Scene3D"
      ] {
        constructor() {
          super({ key: "MainScene" });
        ...
        async resumeLoad() {
          ...
          const textureShadowRing = await this.third.load.texture(
            "shadow_ring_tex"
          );
          ...
          this.planeShadowRing.position.y =
            (-0.2 - 2) / this.frustumSizeChanger;
          ...
          const textureRingSettings = await this.third.load.texture(
            "settings_ring_tex"
          );
          ...
          this.tweens.add({
            ...
            duration: 20000,
            onUpdate: () => {
              this.planeRingSettings.rotation.z =
                (tmpSettings.angle / 180) * Math.PI;
            },
          });
          ...
          this.planeShadowRingSettings.position.x =
            (0.2 + 5.5) / this.frustumSizeChanger;
          this.planeShadowRingSettings.position.y =
            -0.2 / this.frustumSizeChanger;
          ...
          let gradient = this.textReady.context.createLinearGradient(
            0,
            0,
            0,
            this.textReady.height
          );
          ...
          gradient = this.textReady.context.createLinearGradient(
            0,
            0,
            0,
            this.textGo.height
          ...
          gradient = this.textScore.context.createLinearGradient(
            0,
            0,
            0,
            this.textScore.height
          );
          ...
          gradient = this.textBest.context.createLinearGradient(
            0,
            0,
            0,
            this.textBest.height
          );
          ...
          this.planeShadowRingPA.position.x =
            (0.2 - 3) / this.frustumSizeChanger;
          this.planeShadowRingPA.position.y =
            (-0.2 - 3.5) / this.frustumSizeChanger;
          ...
          const textureRingQuit = await this.third.load.texture(
            "quit_ring_tex"
          );
          ...
          this.planeShadowRingQuit.position.x =
            (0.2 + 3) / this.frustumSizeChanger;
          this.planeShadowRingQuit.position.y =
            (-0.2 - 3.5) / this.frustumSizeChanger;
          ...
          this.waveList = [
            {
              ...
              dtScaleIncrease: 0,
              fruitChance: [
                { fruits: ["Watermelon"], min: 1, max: 1, between: 0 },
              ],
            },
            {
              id: 2,
            ...
            },
            {
              ...
              dtScaleIncrease: 0,
              fruitChance: [
                { fruits: ["R", "R", "B"], min: 4, max: 6, between: 0.6 },
              ],
            },
            {
              id: 8,
            ...
            },
            {
              ...
              dtScaleIncrease: 0,
              fruitChance: [
                { fruits: ["R", "R", "R", "B"], min: 3, max: 4, between: 0 },
              ],
            },
            {
              id: 10,
            ...
            },
            {
              ...
              dtScaleIncrease: 0,
              fruitChance: [
                { fruits: ["R", "R", "B"], min: 16, max: 16, between: 0.4 },
              ],
            },
            {
              id: 12,
            ...
            },
            {
              ...
              fruitChance: [
                { fruits: ["R", "R", "R", "B"], min: 5, max: 10, between: 0.4 },
              ],
            },
            {
              id: 16,
              ...
              dtScaleIncrease: 0.02,
              fruitChance: [
                { fruits: ["R", "R", "R", "B"], min: 3, max: 5, between: 0.4 },
              ],
            },
            {
              id: 17,
            ...
            },
            {
              ...
              dtScaleIncrease: 0.02,
              fruitChance: [
                { fruits: ["R", "R", "B"], min: 5, max: 7, between: 0.4 },
              ],
            },
          ];
          this.waveCounter = 0;
          ...
          const textureRingBack = await this.third.load.texture(
            "back_ring_tex"
          );
          ...
          this.planeShadowRingBack.position.x =
            (0.2 + 7.5) / this.frustumSizeChanger;
          this.planeShadowRingBack.position.y =
            (-0.2 - 3.5) / this.frustumSizeChanger;
        ...
        createCreditsText() {
          ...
          startY =
            Math.max(n_code.y + n_code.height, n_design.y + n_design.height) +
            distanceY;
          let t_qa = this.add
            .text(left, startY, "QA", {
              fontFamily: "gangofchinese",
          ...
          startY =
            Math.max(n_qa.y + n_qa.height, n_cs.y + n_cs.height) + distanceY;
          ...
          startY =
            Math.max(
              n_audio.y + n_audio.height,
              n_marketing.y + n_marketing.height
            ) + distanceY;
          ...
          startY =
            Math.max(
              n_teamLead2.y + n_teamLead2.height,
              n_art2.y + n_art2.height
            ) + distanceY;
          ...
          startY =
            Math.max(n_code2.y + n_code2.height, n_qa2.y + n_qa2.height) +
            distanceY;
          ...
          startY =
            Math.max(
              n_audio2.y + n_audio2.height,
              n_production.y + n_production.height
            ) + distanceY;
          ...
          startY =
            Math.max(
              n_leftTeam.y + n_leftTeam.height,
              n_rightTeam.y + n_rightTeam.height
            ) + distanceY;
          let t_ceo = this.add
          ...
          startY =
            Math.max(n_ceo.y + n_ceo.height, n_cfo.y + n_cfo.height) +
            distanceY;
          ...
          startY =
            Math.max(
              n_marketing3.y + n_marketing3.height,
              n_engine.y + n_engine.height
            ) + distanceY;
          let t_qa3 = this.add
            .text(left, startY, "QA", {
              fontFamily: "gangofchinese",
          ...
          startY =
            Math.max(n_qa3.y + n_qa3.height, n_support.y + n_support.height) +
            distanceY;
        ...
        initResultScreen() {
          ...
          let gradient = titleText.context.createLinearGradient(
            0,
            0,
            0,
            titleText.height
          ...
          gradient = titleText.context.createLinearGradient(
            0,
            0,
            0,
            this.newBestText.height
          );
          ...
          for (let i = 0; i < waveUsed.fruitChance.length; i++) {
            ...
            for (let j = 0; j < nFruit; j++) {
              ...
              if (timeSpawn == 0) {
                ...
                this.fruitFactory.scheduleSpawnFruit(
                  toSpawn,
                  10 - counter * 4,
                  xUsed,
                  timeSpawn
      ...
      function pokiCommercialBreak() {
        ...
        PokiSDK.commercialBreak(() => {}).then(() => {
          console.log(
            "*** Poki - Commercial break finished, proceeding to game"
          );
        });
      }
...
\********************************************/ /*!exports provided: default*/ function (
      ...
      class PreloadScene extends Phaser.Scene {
        ...
        preload() {
          ...
          var progressBox = this.add.graphics({
            fillStyle: { color: 0x362f2d, alpha: 0 },
          });
          ...
          var loadingText = this.add.image(
            rect.x + wbar / 2,
            htext + 18,
            "loadingText"
          );
          ...
          this.load.audio(
            "AmbArenaClassicLP",
            "assets/sound/AmbArenaClassicLP.mp3"
          );
          this.load.audio("MusicMenu", "assets/sound/MusicMenu.mp3");
          this.load.audio(
            "BladeRegularSwipe01",
            "assets/sound/BladeRegularSwipe01.mp3"
          );
          this.load.audio(
            "BladeRegularSwipe02",
            "assets/sound/BladeRegularSwipe02.mp3"
          );
          this.load.audio(
            "BladeRegularSwipe03",
            "assets/sound/BladeRegularSwipe03.mp3"
          );
          this.load.audio(
            "BladeRegularSwipe04",
            "assets/sound/BladeRegularSwipe04.mp3"
          );
          this.load.audio(
            "BladeRegularSwipe05",
            "assets/sound/BladeRegularSwipe05.mp3"
          );
          this.load.audio(
            "BladeRegularSwipe06",
            "assets/sound/BladeRegularSwipe06.mp3"
          );
          this.load.audio(
            "BladeRegularSwipe07",
            "assets/sound/BladeRegularSwipe07.mp3"
          );
          ...
          this.load.audio(
            "BombExplodeGameOver",
            "assets/sound/BombExplodeGameOver.mp3"
          );
          this.load.audio(
            "FruitImpactApple",
            "assets/sound/FruitImpactApple.mp3"
          );
          this.load.audio(
            "FruitImpactBigHollow",
            "assets/sound/FruitImpactBigHollow.mp3"
          );
          this.load.audio(
            "FruitImpactBigWet01",
            "assets/sound/FruitImpactBigWet01.mp3"
          );
          this.load.audio(
            "FruitImpactBigWet02",
            "assets/sound/FruitImpactBigWet02.mp3"
          );
          this.load.audio(
            "FruitImpactBigWet03",
            "assets/sound/FruitImpactBigWet03.mp3"
          );
          this.load.audio(
            "FruitImpactMediumDry",
            "assets/sound/FruitImpactMediumDry.mp3"
          );
          this.load.audio(
            "FruitImpactMediumWet01",
            "assets/sound/FruitImpactMediumWet01.mp3"
          );
          this.load.audio(
            "FruitImpactMediumWet02",
            "assets/sound/FruitImpactMediumWet02.mp3"
          );
          this.load.audio(
            "FruitImpactMediumWet03",
            "assets/sound/FruitImpactMediumWet03.mp3"
          );
          this.load.audio(
            "FruitImpactSmallWet01",
            "assets/sound/FruitImpactSmallWet01.mp3"
          );
          this.load.audio(
            "FruitImpactSmallWet02",
            "assets/sound/FruitImpactSmallWet02.mp3"
          );
          this.load.audio(
            "FruitImpactSmallWet03",
            "assets/sound/FruitImpactSmallWet03.mp3"
          );
          ...
          this.load.image(
            "JuiceGreen",
            "assets/textures/particles/JuiceGreen.png"
          );
          this.load.image(
            "JuiceDragonfruit",
            "assets/textures/particles/JuiceDragonfruit.png"
          );
          this.load.image(
            "JuiceMango",
            "assets/textures/particles/JuiceMango.png"
          );
          this.load.image(
            "JuiceOrange",
            "assets/textures/particles/JuiceOrange.png"
          );
          this.load.image(
            "JuicePineapple",
            "assets/textures/particles/JuicePineapple.png"
          );
          this.load.image(
            "StarCritical",
            "assets/textures/particles/StarCritical.png"
          );
          this.load.image(
            "SliceDiamondNeutral",
      ...
      function initializePokiSDK() {
        PokiSDK.init()
          ...
          .catch(() => {
            console.log(
              "*** Poki - SDK Initialized, but the user likely has adblock"
            );
          });
      }
    },
        ...
        constructor(params) {
          ...
          this._material =
            new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__[
              ...
              fragmentShader: _FS,
              blending:
                _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["THREE"]
                  .NormalBlending,
              depthTest: true,
              depthWrite: false,
              transparent: true,
          ...
          this._points =
            new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__[
              "THREE"
            ].Points(this._geometry, this._material);
          ...
          for (let i = 0; i < n; i++) {
            ...
            this._particles.push({
              position:
                new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__[
                  "THREE"
                ].Vector3(this.curX, this.curY, 10),
...
\*************************************/ /*!exports provided: default*/ function (
    ...
    class Button extends Phaser.GameObjects.Image {
      ...
      pointerout() {
        ...
        var last4Text = imageKey.substring(
          imageKey.length - 4,
          imageKey.length
        );
        if (last4Text == "_sel") {
          ...
          if (this.gdfsghk >= this.emitEvery) {
            ...
            this._particles.push({
              position:
                new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__[
                  "THREE"
                ].Vector3(this.curX, this.curY, -30),
              size: 20.0,
              colour:
                new _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__[
                  "THREE"
